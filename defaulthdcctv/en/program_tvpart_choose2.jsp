...
<%@ include file="program_tvpart_choose_ctrl.jsp"%>
</head>
...
<div class="main">
	...
	<div class="menu2"> <!--焦点为 class="menuli on"  当前选中为 class="menuli current"-->
		...
		<div id="menu0" class="menuli">栏目信息</div> <!--class="menuli on"-->
		<div><img src="images/menu_line.png" /></div>
	...
	<div class="side_r">
		...
		<div style="display:none"><b>主持：</b><span id="zhuchi"></span></div>
		<div style="display:none"><b>嘉宾：</b><span id="jiabin"></span></div>
