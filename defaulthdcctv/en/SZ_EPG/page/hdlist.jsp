...
window.onload = function(){	
	area0=AreaCreator(1,3,new Array(6,-1,2,1),"area0_list_","className:item item_focus","className:item");
...
//积分订购按钮区域、链接、选中效果
    ...
    area6.doms[0].mylink = "../../jifen/index.jsp?returnUrl=../SZ_EPG/page/hdlist.jsp?typeid="+typeid;
