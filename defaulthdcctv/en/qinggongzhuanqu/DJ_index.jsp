...
*/
        String returnUrl = null == request.getParameter("returnurl") ? "../index.jsp" : request.getParameter("returnurl");
...
body{ background:url(images/DJ_index.png) no-repeat;z-index:-10; }
	...
	.name{position:absolute;width:260px;height:35px;left:8px;top:10px;font-size:20px;line-height:31px;color:#ffebcd; overflow:hidden;}
...
<div style="position:absolute; width:290px; height:240px; left:15px; top:150px;z-index:2">
    <div id="play_0" style="position:absolute;left:2px;top:3px;display:none;"><img src="images/play.png"     style="width:280px;height:39px"/></div>
    <div id="play_1" style="position:absolute;left:2px;top:43px;display:none;"><img src="images/play.png"  style="width:280px;height:39px" /></div>
    <div id="play_2" style="position:absolute;left:2px;top:83px;display:none;"><img src="images/play.png"  style="width:280px;height:39px"/></div>
    <div id="play_3" style="position:absolute;left:2px;top:123px;display:none;"><img src="images/play.png" style="width:280px;height:39px"/></div>
    <div id="play_4" style="position:absolute;left:2px;top:163px;display:none;"><img src="images/play.png" style="width:280px;height:39px"/></div>
	<div id="play_5" style="position:absolute;left:2px;top:203px;display:none;"><img src="images/play.png" style="width:280px;height:39px"/></div>
...
<a id="media_focus" href="#" onClick="playVod(currPlayVod%pageSize,true);" style="position:absolute;left:300px; top:150px;"><img src="images/dot.gif" width="320" height="245"/></a>
<!--</div>-->
<div style="position:absolute; width:275px; height:238px; left:20px; top:151px;z-index:3">
...
<iframe id="lxj" name="lxj" src="" style="position:absolute; width:593px; height:375px; left:25px; top:89px; display:none;" frameborder="10px"></iframe>
...
function playVod(index,flag)
{
	...
	else
	{
		...
		backurl = "qinggongzhuanqu/DJ_index.jsp?PREFOUCS="+focusObj+","+currPage+","+currPlayVod;
...
function initMediaPlay()
{
	...
	mp.setVideoDisplayArea(300,150,320,245);
