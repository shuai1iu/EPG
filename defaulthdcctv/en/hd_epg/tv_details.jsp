...
function checkBookmark(subVoddetailInfo){
	...
	if(isbookmark==true){  //判断是否有书签
		progId = temppageTurnVodIdList[area1.curindex];
		getAJAXData("check_subscribe.jsp?VODID="+progId+"&FATHERID="+datajson[0].VODID+"&SUBJECTID=-1&CONTENTTYPE="+datajson[0].CONTENTTYPE+"&BUSINESSTYPE=1&PLAYTYPE=1",checksubscribe1);
	}
	else
	{
		getAJAXData("check_subscribe.jsp?VODID="+progId+"&FATHERID="+datajson[0].VODID+"&SUBJECTID=-1&CONTENTTYPE="+datajson[0].CONTENTTYPE+"&BUSINESSTYPE=1&PLAYTYPE=1",checksubscribe);
	}
}
