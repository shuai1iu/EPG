...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en/dibbling.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';			//直播频道地址
xml += '<key_code>KEY_TV_MENU</key_code>';
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en/channel.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en/playback.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en/space_collect.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
