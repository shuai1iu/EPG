...
<%!
	final static String Index_Live_SD="11"; //首页窗口直播Code（标清），暂时使用CCTV5
	final static String Index_Live_HD="1001"; //首页窗口直播Code（标清），暂时使用CCTV5
	
	//首页热词CODE
	final static String Index_Hotkey = "00000100000000090000000000019394";
	
	//首页推荐
	final static String Index_Recommend = "00000100000000090000000000019406";	    
	
	final static String Index_Recommend1 = "00000100000000090000000000019406";
	
	//首页精彩回放
	final static String Index_Besttvod = "00000100000000090000000000019406";
	
	//点播页面推荐
	final static String Vod_Recommend="00000100000000090000000000019406";
	
	//精彩视频
	final static String Wonderful_video="00000100000000090000000000019392";
	
	//球星殿堂
	final static String Star_Hall="00000100000000090000000000019393";
	
	final static String Match_Vod = "00000100000000090000000000019391";
	
//	final static String Top_Score = "00000100000000090000000000019132";
	
	final static String Top_Score = "00000100000000090000000000019407";
