...
<style>
	...
	.pagenum{position:absolute;width:55px;height:25px;left:258px;line-height:30px;line-height:30px;font-size:22px;}
...
<a id="media_focus" href="#" onClick="playVod(currPlayVod%pageSize,true);" style="position:absolute;left:370px; top:195px;"><img src="images/dot.gif" width="245" height="207"/></a>
<!--</div>-->
