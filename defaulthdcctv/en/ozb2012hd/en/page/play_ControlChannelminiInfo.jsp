...
<title></title>
<style type="text/css">
.channel_msg{ position:absolute;top:0px; right:0px; background:url(../images/play/channel_OSD_rbg.png) repeat-y; width:360px; height:720px; padding-left:0px; line-height:46px}
...
<body onLoad="javascript:init_info()" bgcolor="transparent" style="color:#FFFFFF">
    <div class="channel_msg">
		...
		<div class="line"><img src="../images/play/menu_line.png" /></div>
