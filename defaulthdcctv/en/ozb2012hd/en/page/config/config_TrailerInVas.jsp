...
<%
			...
			String CATEGORY_fullScreenPlayUrl="system-error.jsp?ERROR_TYPE=2&ERROR_ID=145";
			String CHANNEL_fullScreenPlayUrl="system-error.jsp?ERROR_TYPE=2&ERROR_ID=145";
			String VOD_fullScreenPlayUrl="system-error.jsp?ERROR_TYPE=2&ERROR_ID=145";
			String NATIVE_fullScreenPlayUrl="system-error.jsp?ERROR_TYPE=2&ERROR_ID=145";
			if(CATEGORY_TRAILER_ID!=null)
			{
				...
				if(CATEGORY_TRAILER_TYPE.equals("VOD")) //窗口视频为点播的情况
				{
					...
					{
						CATEGORY_fullScreenPlayUrl= "system-error.jsp?ERROR_TYPE=2&ERROR_ID=129";
					}
					else
					{
