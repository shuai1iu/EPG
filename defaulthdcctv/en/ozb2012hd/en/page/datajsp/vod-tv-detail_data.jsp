...
<%
	...
	if(mediadetailInfo!=null){
		...
		if("".equals(catename)){
			if(!("-1".equals(typeid))  && !("00000100000000090000000000019596".equals(typeid)) ){
	...
	ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(Vod_Recommend,6,0);
...
function bindContentData(itm) {
	...
	itm.VODNAME = (getbytelength(itm.VODNAME)>38)?getcutedstring(itm.VODNAME,38):itm.VODNAME;
	$("vodName").innerHTML ="名称:"+ itm.VODNAME;
	...
	$("vodItd").innerHTML = "简介:"+itm.INTRODUCE;
	
	$("area0_img_0").src = isfaved?"../images/btn-favorites-del.png":"../images/btn-favorites.png";
}
