...
<div class="index-video">  
	<div class="item">	
		...
		<div class="pic"><!--<img src="../images/temp/video-651X490.jpg" />-->
			<iframe id="playPage" name="playPage" src="" border="0" frameSpacing="0" marginWidth="0" marginHeight="0" frameBorder="0" noResize scrolling="no" vspace="0" width="895" height="377" style="background:transparent;"></iframe>
		</div>		
	</div>
</div>
<!--the end-->
