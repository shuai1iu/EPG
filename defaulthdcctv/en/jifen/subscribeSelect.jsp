...
{
System.out.println("CHECKMAP=="+retCheckMap);
    if( null != retCheckMap)
    {
...
<div id="infomation" style="visibility:visible;">
    ...
    <div class="texts" id="info_text_1" style="top:0px;font-weight:bold;"></div>
    <div class="texts" id="info_text_2" style="top:50px;"></div>

</div>
<div id="choices" style="visibility:visible;">
	<div class="button" id="choice_buy" style="line-height:47px;font-size:30px;color:#C7F6FF;text-align:center;font-weight:bold;top:10px; left:0px; background:url('images/green.png') no-repeat; ">积分订购</div>
    <div class="button" id="choice_back" style="line-height:47px;font-size:30px;color:#C7F6FF;text-align:center;font-weight:bold;top:10px; left:306px; background:url('images/green.png') no-repeat; ">返回</div>
</div>
