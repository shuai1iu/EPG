...
<%
	...
	if("1".equals(isIntegration))
	{
		...
		orderfilm = serviceHelpHWCTC.subscribeHWCTC(prodId+"", serviceId, prodCont,contentType,contentId,businessType,fatherSeriesId,2);
	}
    ...
    if(ret_code == EPGErrorCode.SUBSCRIPTION_SUCCESSED)
    {
        ...
        if(1 == returnflag){
			...
			prevPageUrl = "play_pageControl.jsp?" + queryStr.toString();
		}
