...
<div style="position:absolute; width:593px; height:375px; left:0px; top:0px;">
    ...
    <a id="but_focus_0" href="#" onClick="keyPageDown()" style="left:172px; top:198px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
    <a id="but_focus_1" href="#" onClick="keyPageUp()" style="left:251px; top:198px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
    
    <a id="but_focus_2" href="#" onClick="keyBack()" style="left:330px; top:198px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
    ...
    <div style="position:absolute; width:496px; height:125px; top:240px; left:43px;">
        ...
        <a href="#" id="num_focus_20" style=" left:5px; top:79px;" onClick="playVod(20);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_21" style=" left:54px; top:79px;" onClick="playVod(21);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_22" style=" left:103px; top:79px;" onClick="playVod(22);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_23" style=" left:152px; top:79px;" onClick="playVod(23);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_24" style=" left:201px; top:79px;" onClick="playVod(24);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_25" style=" left:250px; top:79px;" onClick="playVod(25);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_26" style=" left:299px; top:79px;" onClick="playVod(26);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_27" style=" left:348px; top:79px;" onClick="playVod(27);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_28" style=" left:397px; top:79px;" onClick="playVod(28);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
        <a href="#" id="num_focus_29" style=" left:446px; top:79px;" onClick="playVod(29);" class="num_focus"><img src="images/dot.gif" width="40" height="38"/></a>
    </div>
</div>
...
{
	parent.saveFocus();
	parent.window.location.href = "../play_controlVod.jsp?PROGID="+vodInfo.subVodIdList[index+pageSize*currPage]+"&FATHERSERIESID="+vodId+"&PLAYTYPE=1&BEGINTIME=0&PRODUCTID=0&SERVICEID=0&ONECEPRICE=0&CONTENTTYPE=10&returnurl="+parent.backurl;
}
function keyBack()
{
	parent.focus();
