...
<!--list-->
<div class="leftcol02 list"> <!--当前选中则显示<div class="icon02"></div>-->
	<div class="item bg01">
		<div class="link"><a href="#" id="vod_a_0" onclick="gotopaly(0)" onfocus="showFullName(0)" onblur="showCutName(0)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg02" style="top:49px;">
		<div class="link" ><a href="#" id="vod_a_1" onclick="gotopaly(1)" onfocus="showFullName(1)" onblur="showCutName(1)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg01" style="top:98px;">
		<div class="link"><a href="#" id="vod_a_2" onclick="gotopaly(2)" onfocus="showFullName(2)" onblur="showCutName(2)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg02" style="top:147px;">
		<div class="link"><a href="#" id="vod_a_3" onclick="gotopaly(3)" onfocus="showFullName(3)" onblur="showCutName(3)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg01" style="top:196px;">
		<div class="link"><a href="#" id="vod_a_4" onclick="gotopaly(4)" onfocus="showFullName(4)" onblur="showCutName(4)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg02" style="top:245px;">
		<div class="link"><a href="#" id="vod_a_5" onclick="gotopaly(5)" onfocus="showFullName(5)" onblur="showCutName(5)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg01" style="top:294px;">
		<div class="link"><a href="#" id="vod_a_6" onclick="gotopaly(6)" onfocus="showFullName(6)" onblur="showCutName(6)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg02" style="top:343px;">
		<div class="link"><a href="#" id="vod_a_7" onclick="gotopaly(7)" onfocus="showFullName(7)" onblur="showCutName(7)"><img src="<%=static_url%>/images/t.gif" /></a></div>
	...
	<div class="item bg01" style="top:392px;">
		<div class="link"><a href="#" id="vod_a_8" onclick="gotopaly(8)" onfocus="showFullName(8)" onblur="showCutName(8)"><img src="<%=static_url%>/images/t.gif" /></a></div>
		<div class="txt" id="vod_8" style="overflow:hidden"></div>
        <div class="icon02" id="flage_8" style="display:none"></div>
	</div>
	<div class="item bg02" style="top:441px;">
		<div class="link"><a href="#" id="vod_a_9" onclick="gotopaly(9)" onfocus="showFullName(9)" onblur="showCutName(9)"><img src="<%=static_url%>/images/t.gif" /></a></div>
		<div class="txt" id="vod_9" style="overflow:hidden"></div>
        <div class="icon02" id="flage_9" style="display:none"></div>
	</div>
</div>
...
<div class="hd-r-poster02">
	...
	<div class="poster">
    	<div class="link" style="margin-left:0px"><a href="#" id="vofulldpaly" onclick="vofulldpaly()" onfocus="setAre(2)"><img width="572" height="430" src="<%=static_url%>/images/t.gif" /></a></div>
		<div class="pic">
...
function myCallBack(respText)
{
	 ...
	 if(len>0)
	 {
		 ...
		 for(var i=0;i<len;i++)
		 {
			$("vod_"+i).innerText = vodList[i].dname.substr(0,19);
...
function loadIframe(){
	...
	{
		if(vodList[flage].ddescription.length>40)
		{
...
function  pkPlay(){
	...
	backUrl = "<%=static_en%>/page/zrjp.jsp?area=2&pageIndex="+pageIndex+"&flage="+flage+"&cruntdblistFocusPageIndex="+cruntdblistFocusPageIndex+"&cruntDBListFocus="+cruntDBListFocus+"&dbLisVodId="+dbLisVodId+"&pressListOKFlage="+pressListOKFlage+"&vodDiscription="+vodDiscription+"&FanyeQianIDList="+FanyeQianIDList+"&categoryId=<%=categoryId%>";
...
<div style="position:absolute; left:1163px; top:254px; width:54px; height:66px; z-index:4;"><img id="voice" src="<%=static_url%>/images/dot.gif"/></div>
</body>
</html>
