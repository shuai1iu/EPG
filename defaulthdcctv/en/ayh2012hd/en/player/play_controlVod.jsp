...
function changeAudio()
{
	...
	{
		case 0:
		$("voice").src="playerimages/leftvoice.png";
		break;
		case 1:
		$("voice").src="playerimages/rightvoice.png";
		break;
		case 2:
		$("voice").src="playerimages/centervoice.png";
		break;
		default:
		break;
	}
	voiceflag=setTimeout(function(){$("voice").src="playerimages/dot.gif";},5000);
...
function setMuteFlag()
{
	...
	if(muteFlag == 1){
		...
		{
			$("voice").src="playerimages/muteoff.png";
		...
		if (mp.getNativeUIFlag() == 0 || mp.getMuteUIFlag() == 0)
		{
			$("voice").src="playerimages/muteon.png";
		}
	}
...
function hideMute()
{
	...
	function genVolumeTable(volume)
    {
    	...
    	tableDef += '<td width="20px"></td><td width="40px"><img border="0" src="playerimages/volume.gif"></td><td width="40px" style="color:white;font-size:28">' + volume + '</td>';
...
function volumeDown()
{
    ...
    function displaySeekTable(playFlag)
    {
        ...
        if(isSeeking == 0)
        {
            ...
            $("statusImg").innerHTML = '<img border="0" src="playerimages/pause.png" width="40" height="40"/>';			
			$("seekDiv").style.display = "block"; //显示进度条
			//显示跳转框		   
			// $("jumpTimeHour").focus(); //给跳转框落焦点 20120315屏蔽
			jumpPos=4;
		    $("currentTime_progress").style.background="url(playerimages/chanMini_timePro.png)";
            //6秒后隐藏跳转输入框所在的div
...
function playByTime(beginTime)
{
	...
	count=0;
	jumpPos=0;
	$("currentTime_progress").style.background="url(playerimages/chanMini_lostTimePro.png)";	
	$("jumpTimeHour").focus();
}
...
function fastForward()
{
	...
	$("statusImg").innerHTML = '<img border="0" src="playerimages/fastForward.png" width="20" height="20"/>&nbsp;X'+speed;
}
...
{	
	...
	playStat = "fastrewind";				
	mp.fastRewind(-speed);				
	$("statusImg").innerHTML = '<img border="0" src="playerimages/fastRewind.png" width="20" height="20"/>&nbsp;X' + speed;
}
...
{	
	...
	if(url.indexOf("?")>0){
	 ...
	 var pkbackUrl = getURLtoCookie("vodPlay");
	 pkbackUrl = (pkbackUrl!="")?pkbackUrl:"<%=static_en%>/page/index.jsp";
	 location.href = pkbackUrl;
}
...
<a id="currentTime" href="#" style="width:1px; height:1px; top:-1px; left:-1px;"><img src="playerimages/dot.gif" width="1" height="1"/></a>
</div>
...
<div id="seekDiv" style="position:absolute;width:1280px;height:200px;left:0px;top:413px; z-index:1;display:none;">
  ...
  <div id="seekPercent" style="position:absolute;color:#FFFFFF;width:45;height:23;top:139;left:640;z-index:3;"></div>
    <!--进度点-->
  <div id="currentTime_progress" style="position:absolute;left:343px;top:168px;width:23px;height:23px; z-index:3; background:url(playerimages/chanMini_lostTimePro.png);"></div>


  <!-- 进度条所在div -->
  <div style="position:absolute; background:url(playerimages/control_bbg.png) repeat-x; width:100%; height:237px;left:0;top:87;z-index:-2;"></div>
  ...
  <div id="jumpTimeDiv" style="position:absolute;width:1280;height:76;left:0;top:205px;z-index:3;color:white;">
    <table width="1280" height="76" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr height="36">
        ...
        <td width="280" valign="middle" align="center"><a id="ensureJump" href="javascript:clickJumpBtn();"><img src="playerimages/ensureJump.png" width="73" height="28"/></a> &nbsp;&nbsp;&nbsp;&nbsp; <a id="cancelJump" href="javascript:pauseOrPlay();"><img src="playerimages/cancelJump.png" width="73" height="28"/></a> </td>
      </tr>
      <tr>
        <td height="5" colspan="6"></td>
      </tr>
...
<%--minEPG显示层开始--%>
<div style="position:absolute; left:15px; top:15px; width:54px; height:66px; z-index:3;"><img id="voice" src="playerimages/dot.gif"/></div>
<div id="minEpgDiv" style="display:none;">
<div id="minEpgBackground" style="position:absolute; bottom:0; background:url(playerimages/control_bbg.png) repeat-x; width:1280px; height:237px;left:0px; top:500px; z-index:1;"></div>
...
<%-- AD-begin--%>
<div id="bottomAd" style="position:absolute; bottom:0; left:0; background:url(playerimages/bottombg.png) repeat-x; width:1280px; height:152px;z-index:4;display:none;">
		<div class="bottom_ad" style="position:absolute; top:40px; left:72px"><img src="playerimages/ad_1.jpg" /><img src="playerimages/ad_2.jpg" /><img src="playerimages/temp/ad_3.jpg" /></div>	
</div>
<%--AD-END--%>
...
<div style="position:absolute; left:255px; top:135px; width:380px; height:262px;" align="center">
 <img src="playerimages/popup_bg2.png" height="380" width="730"> </div>
...
<div style="position:absolute; left:390px; top:155px; width:730px; height:480px; z-index:2; color:#FFFFFF; font-size:32px;">
  ...
  <a id="quit" href="javascript:quit();" style="position:absolute; left:77px; top: 182px;"><img src = "playerimages/dot.gif" width="83px" height="36px"/></a> 
  <a id="cancel" href="javascript:cancel();" style="position:absolute;left:290px; top:182px;"><img src = "playerimages/dot.gif" width="83px" height="36px"/></a>
  <!--<a id="bookmark" href="javascript:saveBookMark();" style="position:absolute;left:138px; top:200px;"><img src = "playerimages/dot.gif" width="225px" height="36px"/></a>--> 
</div>
...
<!--连续剧播放下一集-->
<div id="finishedBackground" style="position:absolute;  display:none; left:255px; top:135px; width:730px; height:380px; "> 
<img src="playerimages/popup_bg2.png" height="380" width="730"> </div>
<div id="preNextDiv" style="position:absolute; left:500px; top:155px; width:730px; display:none;  height:480px; z-index:2; color:#FFFFFF; font-size:24px;">
  <table height="200" width="320">
    <tr height="60">
      <td colspan="5">&nbsp;</td>
    </tr>
    <tr>
  ...
  <div style="position:absolute; left:-80px; top:170px;"> <img height="120px" width="450px" src="playerimages/11.jpg" /> </div>
  <a id="nextProg" href="javascript:goNextProg();" style="position:absolute; left: 13px; top: 145px;"><img src = "playerimages/dot.gif" width="83px" height="36px"/></a>
  <a id="finishedQuit" href="javascript:quit();"  style="position:absolute;left:170px; top:145px;"><img src = "playerimages/dot.gif" width="83px" height="36px"/></a> </div>
...
<%--错误提示层--%>
<div id="errorDiv" style="position:absolute; left:120px; top:300px; width:400px; height:80px; z-index:-1; display:none"> <img src="playerimages/errorBack.gif" width="400px" height="80px"/> </div>
...
<div style="display:none;">
<img src="playerimages/popup_bg2.png" />
<img src="playerimages/pause.png" />
