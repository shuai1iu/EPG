...
function addURLtoCookie(flag,url)
{
  ...
  var value = "", newvalue = "", isExist = false;
...
{
    if(days){
        var date = new Date(); date.setTime(date.getTime()+(days*86400000)); //24*60*60*1000=86400000
        var expires = "; expires="+date.toGMTString();
    }
    else{ var expires = ""; }
    document.cookie = name+"="+value+expires+"; path=/";   //index=value;expires=1249389385909
}
