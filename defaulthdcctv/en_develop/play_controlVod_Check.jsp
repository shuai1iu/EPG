...
function check(){
	...
	displayBuy();
	if(picpath != "false"){
		document.getElementById('img_0').src = "url(" + picpath + ")";
	}
	if(vodname != "false"){
...
<div id="choices" style="visibility:visible; width:1280px; height:720px; position:absolute; z-index:21; background:url('images/play_controlVod_Prompt.png') no-repeat;">
	<img class = "images" id = "img_0" style = " position:absolute; z-index:12; width:256px; height:339px; top:167px; left:178px; "/>
