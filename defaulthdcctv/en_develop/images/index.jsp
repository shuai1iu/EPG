...
//	area3.setfocuscircle(0);
	area5 =AreaCreator(1,2,new Array(3,-1,3,-1),"area5_recommend_","className:recommend on","className:recommend");
        area5.stablemoveindex=new Array("0-3>3,1-3>3",-1,3,-1);
	for(i=0;i<4;i++)
...
/*
    ...
    @date 2013-09-06
*/
//        area5 =AreaCreator(1,1,new Array(3,-1,3,-1),"area5_recommend_","className:recommend on","className:recommend");
	 area5 =AreaCreator(1,1,new Array(3,-1,3,-1),"area5_recommend_");
	area5.stablemoveindex=new Array("0-3>3",-1,3,-1);
...
/*
    ...
    @ 2013-09-07
*/
        area3.areaInedEvent = function(){ window.clearInterval(changeRecommend);}
...
<div id="area4_list_1" class="item item02" style="left:94px;top:44px;">
...
<div id="area4_list_9" class="item item02" style="left:94px;top:85px;">
