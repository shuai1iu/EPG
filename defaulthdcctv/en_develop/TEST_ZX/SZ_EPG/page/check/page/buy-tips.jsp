...
<%
   String prodname= session.getAttribute("prodname")==null?"高清尊享包":(String) session.getAttribute("prodname");
%>
...
<head>
	...
	<script type="text/javascript">
	   ...
	   window.onload = function(){
		   ...
		   pageobj.backurl ="upgradeorder.jsp";
		   area0.doms[0].domOkEvent=function(){
	            window.location.href="upgradeorder.jsp";
           };
	   }
...
<div class="wrapper">
    ...
    <!-- S 页面头部 -->
    <div class="j-logoPageTitle"><%=prodname%> <span class="f">订购</span></div>
    <!-- E 页面头部 -->

    <!-- S 页面内容 -->
    <div class="j-tipsBox">
        <div class="j-title">尊敬的用户：</div>
        <div class="j-cont">您已成功订购<%=prodname%>,谢谢!</div>
