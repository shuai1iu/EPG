...
ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(pianhua,pagesize,stratPosition);
...
trailersFilmData=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(trailersFilmData);
}
</script>