...
ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(jingsong,pagesize,stratPosition);
...
thrillerFilmData=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(thrillerFilmData);
}
</script>