...
ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(aiqing,pagesize,stratPosition);
...
affectionalFilmData=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(affectionalFilmData);
}
</script>