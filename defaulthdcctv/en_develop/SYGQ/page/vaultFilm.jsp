...
<%@ include file="datajsp/vaultFilmData.jsp"%>
...
<title>片库-深圳首映专区高清 EPG3.0</title>
...
{
    area4=AreaCreator(1,1,new Array(-1,-1,0,-1),"area4_list_","className:item item_focus","className:item ");
	...
	area2 = AreaCreator(8,2,new Array(1,-1,3,-1),"area2_list_","className:item item_focus","className:item");
	//area2.stablemoveindex=new Array("4-0>3","4-0>3","0-1>0","3-0>4");
	//area1.setfocuscircle(1);
	area2.pagecount = Math.ceil(contentTotal/16);
	for(i=0;i<16;i++)
	{
	...
	area2.areaOkEvent = function()
	{
		...
		{
			window.location.href="detail.jsp?vodid="+temppageTurnList[area2.curindex].VODID+"&cateNamePosition=7&returnurl="+escape(location.href)+"&typeid=<%=pianku%>";
			saveFocstr(pageobj);
		}
	}
	...
	area2.asyngetdata=function()
	{
		...
		$('hidden_frame').src = "<%=basePath%>datajsp/vaultFilmData.jsp?isFirstFlag=1&stratPosition="+(this.curpage-1)*16;
		//getAJAXData("datajsp/vaultFilmData.jsp?stratPosition="+(this.curpage-1)*8+"&isFirstFlag=1",bindFilmsData);
		
	}
	//bindFilmsData(piankuData);
	
	area1 = AreaCreator(1,4,new Array(0,-1,2,-1),"area1_list_","className:item item_focus","className:item");
	area1.stablemoveindex = new Array("0-7,1-7,2-7,3-7",-1,-1,-1);
	area1.areaOkEvent = function()
	{
		...
		else if(area1.curindex==3)
		{
			   ...
			   &&area1_numString>0&&area1_numString<=area2.pagecount)
			{
			    ...
			    $('hidden_frame').src = "<%=basePath%>datajsp/vaultFilmData.jsp?isFirstFlag=1&stratPosition="+(area2.curpage-1)*16;
			}
			else
			{
				area1_numString="";
	...
	pageobj = new PageObj(areaid!=null?parseInt(areaid):0,indexid!=null?parseInt(indexid):7, new Array(area0,area1,area2,area3,area4),null);
	pageobj.changefocus(areaid!=null?parseInt(areaid):0,indexid!=null?parseInt(indexid):7);
...
function bindFilmsData(datavalue)
{
	...
	var start = (area2.curpage-1)*16;
	var size = (contentTotal-start)>=16?16:(contentTotal-start);
	...
	for(i=0;i<area2.doms.length;i++)
	{
	   if(i<datavalue.length)
	   {
		   area2.doms[i].setcontent("",datavalue[i].VODNAME,40,true,true);
	...
	var tempLength = datavalue.length - 1;
	area3.stablemoveindex = new Array("0-"+tempLength+",1-"+tempLength+",2-"+tempLength+",3-"+tempLength,-1,-1,-1);
	...
	pageobj.changefocus(pageobj.curareaid,pageobj.areas[pageobj.curareaid].curindex);
}
...
<body>
	...
	<!--menu-->
		<div class="menu">
        	<div class="item item_select" style="z-index:-2;left:1064px;"></div>
			<!--焦点 
				class="item item_focus"
				选中
	...
	<div class="list-b">
		...
		<div class="item" id="area2_list_1" style="left:586px;">
			<div class="txt" id="area2_text_1"></div>
		</div>
		<div class="item" id="area2_list_2" style="top:56px;">
			<div class="txt"  id="area2_text_2"></div>
		</div>
		<div class="item" id="area2_list_3" style="left:586px;top:56px;">
			<div class="txt" id="area2_text_3"></div>
		</div>
		<div class="item" id="area2_list_4" style="top:112px;">
			<div class="txt" id="area2_text_4"></div>
		</div>
		<div class="item" id="area2_list_5" style="left:586px;top:112px;">
			<div class="txt" id="area2_text_5"></div>
		</div>
		<div class="item" id="area2_list_6" style="top:168px;">
			<div class="txt" id="area2_text_6"></div>
		</div>
		<div class="item" id="area2_list_7" style="left:586px;top:168px;">
			<div class="txt" id="area2_text_7"></div>
		</div>
		<div class="item" id="area2_list_8" style="top:224px;">
			<div class="txt" id="area2_text_8"></div>
		</div>
		<div class="item" id="area2_list_9" style="left:586px;top:224px;">
			<div class="txt" id="area2_text_9"></div>
		</div>
		<div class="item" id="area2_list_10" style="top:280px;">
			<div class="txt" id="area2_text_10"></div>
		</div>
		<div class="item" id="area2_list_11" style="left:586px;top:280px;">
			<div class="txt" id="area2_text_11"></div>
		</div>
		<div class="item" id="area2_list_12" style="top:336px;">
			<div class="txt" id="area2_text_12"></div>
		</div>
		<div class="item" id="area2_list_13" style="left:586px;top:336px;">
			<div class="txt" id="area2_text_13"></div>
		</div>
		<div class="item" id="area2_list_14" style="top:392px;">
			<div class="txt" id="area2_text_14"></div>
		</div>
		<div class="item" id="area2_list_15" style="left:586px;top:392px;">
			<div class="txt" id="area2_text_15"></div>
		</div>
	</div>
	<!--list the end-->
