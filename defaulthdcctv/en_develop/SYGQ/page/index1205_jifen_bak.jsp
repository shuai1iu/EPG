   ...
   <!--head-->
	<div class="btn btn-buy">
		...
		<div class="item" id="area7_list_0"><!--特惠包月--></div>
         ...
         <!----���ֶ���--->
        <div class="btn btn-buy"  style="left:540px;top:26px">
            <div id="jifen_0" ><img src="../images/jifen.png" /></div>
        </div>
         <div class="btn btn-buy"  style="left:845px;top:43px;color:#FFFFFF;">
            <div id="jifentxt" style="text-align:center" ></div>
         </div>
