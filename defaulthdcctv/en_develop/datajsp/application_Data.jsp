...
String preFocus = null == request.getParameter("PREFOUCS") ? "0,"+indexid+",1" : request.getParameter("PREFOUCS");
/*以下做对页面初始化焦点的解析*/
if(preFocus!=null)
{
String[] preFocusArray = preFocus.split(",");
areaid =Integer.parseInt(preFocusArray[0]);
indexid =Integer.parseInt(preFocusArray[1]);
curpage =Integer.parseInt(preFocusArray[2]);
}
