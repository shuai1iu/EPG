...
ArrayList array=new MyUtil(request).getVasListData(shouyetuijian1code,17);
...
ArrayList hdfourarray=new MyUtil(request).getVasListData(hdfourcode,4);
if(hdfourarray == null){hdfourarray = new ArrayList();}
ArrayList hdtwoarray=new MyUtil(request).getVasListData(hdtwocode,12);
if(hdtwoarray == null){hdtwoarray = new ArrayList();}
ArrayList array1=new MyUtil(request).getVodListData(shouyetuijian2code,2);
ArrayList array2=new MyUtil(request).getVasListData(shouyetuijian3code,1);
ArrayList array3=new MyUtil(request).getVasListData(shouyetuijian4code,1);
...
ArrayList tmpimgVas=(ArrayList)metadata.getVasListByTypeId(shouyetuijian3code, 1, 0);
int vaslength=0;
...
ArrayList tmpimgVas3=(ArrayList)metadata.getVasListByTypeId(shouyetuijian4code, 1, 0);
