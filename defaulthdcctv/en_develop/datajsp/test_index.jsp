...
<%
	...
	ArrayList tmpvas;
	try{
		tmpvas=(ArrayList)new MetaData(request).getVasListByTypeId("10000100000000090000000000035250",6,0);
	}catch(Exception e){
	}
	System.out.println("======================================================================================pointer1========================"+tmpvas);
		if(tmpvas!=null)
		{
...
<!--20130909 10:00 ZSZ 修改背景图显示规避用户重启前不能重新加载背景图图片-->
 <div id="ad">
	<iframe id="frame_content" onload="iFrameHeight()" scrolling="no" frameborder="0"  width="100%"></iframe>
 </div>
<div id="index">
