...
<%
	...
	if(allOriResultList!=null&&allOriResultList.size()>1){
		...
		System.out.println("==================testList2================================"+ParseResultList);		
	}
	...
	HashMap tempNewMap = new HashMap();
	tempNewMap.put("TYPE_ID","10000100000000090000000000035632");
	tempNewMap.put("TYPE_NAME","测试栏目");
