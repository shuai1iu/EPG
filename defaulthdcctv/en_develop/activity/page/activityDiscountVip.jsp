...
String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/jsp/defaulthdcctv/en_develop/"+returnUrl;
...
System.out.println("returnUrl==="+basePath);
%>
<!--menu-->
	<div class="menu">
	</div>
...
/**
	...
	* Date 2013-11-05
**/
	location.href=targetUrl+"?localIp=<%=localIP%>&userId=<%=itvUserId%>&userToken=<%=userToken%>&backUrl=<%=basePath%>&pageId=<%=pageId%>";  //可配置入口定制
}
</script>
</body>
</html>
