<!-- 版  权：Copyright pukka Tech. Co. Ltd. All Rights Reserved. -->
<!-- 描  述：独立的Trailer播放页面,不仅可以用来播放后台配置的Trailer播放，也可以根据传来的参数播放任何VOD或是CHAN;-->
<!-- 文件名：PlayTrailerInVas.jsp -->
<!-- 修改人：mxr -->
<!-- 修改时间：2011-08-09 -->
...
<%  
	...
	*/
    function play()
    {
	      mp.setVideoDisplayArea(362,96,510,396);
	//	  mp.setVideoDisplayArea(left,top,width,height);
    	  mp.setVideoDisplayMode(0);
		  mp.refreshVideoDisplay();
		  if(playtype == "CHAN")
		  {
			   mp.joinChannel(parseInt('<%=shouyezhibo%>'));//channelIndex 20111220修改深圳
		  }
