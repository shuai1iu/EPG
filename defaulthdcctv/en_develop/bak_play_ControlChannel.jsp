...
.channel_choose{ position:absolute;left:0px top:0; background:url(images/playerimages/channel_OSD_lbg.png) repeat-y; width:435px; height:720px;}
...
var NumActionOn = 0;//直播号OK键处理
var jumpNum = 0;//直播号OK键跳转频道号
var showchannelName = "";//当前频道名称
...
function channelNumAction(num)
{
	...
	//var tabdef = '<table width=800 height=140><tr align="center"><td><font color=white size=120px>';
...
function inputNum(i)
{
	//直播号ok键跳转开启
	NumActionOn = 1;
	if(quitDivIsShow||getDataFlag=="false"||"false" == channelListFlag||number * 10 >= 1000){return;}
	if(bottomLineNum !=0)
	{
	...
	if(numCount >= 3||seekDivIsShow){return;}
	numCount++;
	tempNumber = tempNumber+""+i;
	number = number * 10 + i;
	jumpNum = number;//20130911 15:19 ZSZ ok键跳转频道
...
<div id="no_order" style="position:absolute; right:300;top:60px; width:750px; height:135px; display:none">
  <table width="750px" height="135px" border="0">
    ...
    <tr>
      <td id="orderInfo" width="750px" align="center" style="font-size:40px; color:#FFF;"></td>
    </tr>
    <tr>
      <td id="showmessage" width="750px" align="center" style="font-size:40px; color:#FFF;"></td>
    </tr>
    <tr>
      <td  height="40"></td>
    </tr>
...
<!-- 右上显示直播号-->
<div id="topframe" style="position:absolute;left:500px; top:8px; width:300px; height:70px; z-index:1; font-size:70px; text-align:center; color:#FFF;"></div>

<!--2013.09.04 ZSZ 增加频道名称-->
<div id="topframe_channelName" style="position:absolute;left:500px; top:83px; width:300px; height:40px; z-index:1; font-size:40px; text-align:center; color:#FFF; font-family:'微软雅黑'"></div>
<!--2013.09.04 ZSZ 增加频道名称-->

<div id="topframe_bottomLine" style="position:absolute;left:675px; top:10px; width:600px; height:140px; z-index:2"></div>
