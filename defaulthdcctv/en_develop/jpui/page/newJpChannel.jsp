...
<%
	...
	for(int j=0;j<result1.size();j++)
	{
		...
		int issub = ((Integer)chanInfomap.get("ISSUBSCRIBED")).intValue(); 
		int pltvstatus = ((Integer)chanInfomap.get("PLTVSTATUS")).intValue();
		...
		chanInfomap1.put("issub",issub);
		chanInfomap1.put("pltvstatus",pltvstatus);
...
<script type="text/javascript">
 ...
 <frameset rows="0,100" frameborder="no" border="0" framespacing="0">
	...
	<frame name="viewFrame" width="1280px" height="720px" src="playJPChannel.jsp?ishownum=1&channelid=<%=channelid%>&channelcode=<%=channelcode%>&area0index=<%=area0index%>&area1index=<%=area1index%>&area2index=<%=area2index%>" scrolling="no"></frame>
    <noframes>
