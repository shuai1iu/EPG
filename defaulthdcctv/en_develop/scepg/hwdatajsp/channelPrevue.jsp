...
<%
	...
	String varName = request.getParameter("varName")==null?"tempChannelPrevue":request.getParameter("varName").toString();
	...
	String[] prevue = metadata.getProgBill(Integer.parseInt(channelId),curdate);
