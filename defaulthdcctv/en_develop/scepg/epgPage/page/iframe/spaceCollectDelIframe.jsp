...
String strFavouriteFile="../../../" + datajspname  + "/delFavourite.jsp";
%>
<jsp:include page="<%=strFavouriteFile%>">             
		...
		<jsp:param name="varName" value="tempDelFav"/>
        <jsp:param name="isJson" value="-1"/>
</jsp:include>
<%
	JSONObject tempDelFav=new JSONObject();
	if(request.getAttribute("tempDelFav")!=null){
		tempDelFav = (JSONObject)request.getAttribute("tempDelFav");
	}
...
<head>
<title>spaceCollectDelIframe</title>
<script type="text/javascript">
var data=<%=tempDelFav%>;
		  function init(){
               parent.delCollect(data);
          }
</script>
</head>
<body onload="init()">
