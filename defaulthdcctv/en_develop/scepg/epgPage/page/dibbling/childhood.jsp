...
<script type="text/javascript">
		...
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=childhoodLeftVodCode%>"/> 
			<jsp:param name="varName" value="childhoodLeftList"/>
		...
		<jsp:include page="<%=strFileCate%>">             
			<jsp:param name="parentCategoryCode" value="<%=childhoodCatagoryCenterUpCode%>" /> 
			<jsp:param name="pageIndex" value="1" /> 
			<jsp:param name="pageSize" value="3" /> 
			<jsp:param name="varName" value="childhoodCatagoryCenterUpList" />
		...
		//中下热播推荐
		<jsp:include page="<%=strfile%>">             
			<jsp:param name="categoryCode" value="<%=childhoodCenterDVodCode%>" /> 
			<jsp:param name="varName" value="childhoodCenterDVodList" /> 
			<jsp:param name="pageIndex" value="0" /> 
		...
		//右下主编推荐
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=childhoodRightDVodCode%>" /> 
			<jsp:param name="varName" value="childhoodRightDVodList" /> 
			<jsp:param name="pageIndex" value="0" /> 
		...
		//右上最新上线
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=childhoodRightUVodCode%>" /> 
			<jsp:param name="varName" value="childhoodRightUVodList" /> 
			<jsp:param name="pageIndex" value="0" /> 
		...
		//中间下栏目
		<jsp:include page="<%=strFileCate%>">   
			<jsp:param name="parentCategoryCode" value="<%=childhoodCatagoryCenterCode%>" /> 
			<jsp:param name="pageIndex" value="1" />
			<jsp:param name="pageSize" value="10" />
			<jsp:param name="varName" value=" childhoodCatagoryCenterList" />
			<jsp:param name="fileds" value="-1" />
			<jsp:param name="isBug" value="1" />
		</jsp:include>
...
window.onload=function(){
		...
		{  
			if(childhoodLeftList.vodDataList[area0.curindex].programType == 1)
			{
			 window.location.href = "children-single-detail.jsp?programCode="+childhoodLeftList.vodDataList[area0.curindex].programCode+"&contentCode="+childhoodLeftList.vodDataList[area0.curindex].contentCode+"&categoryCode="+childhoodLeftList.vodDataList[area0.curindex].categoryCode;				
			}else
			{
			 window.location.href = "children-much-detail.jsp?programCode="+childhoodLeftList.vodDataList[area0.curindex].programCode+"&contentCode="+childhoodLeftList.vodDataList[area0.curindex].contentCode+"&categoryCode="+childhoodLeftList.vodDataList[area0.curindex].categoryCode;			   
			}
		};		
		...
		{
			 $("themeImage").src =childhoodCatagoryCenterUpList.categoryList[area1.curindex].pictureList.poster;
		};
		area1.areaOkEvent = function()
		{
			var parentCategoryCode=childhoodCatagoryCenterUpList.categoryList[area1.curindex].parentCategoryCode;
			var categoryCode=childhoodCatagoryCenterUpList.categoryList[area1.curindex].categoryCode;
			var curindex=area1.curindex;
			if(categoryCode=="<%=ChildrenProgCode%>")
			{
				window.location.href="children-column.jsp?parentCategoryCode="+parentCategoryCode+"&categoryCode="+categoryCode+"&index=6";
				
			}else if(categoryCode=="<%=ChildrenSpeciaCode%>")
			{
				window.location.href="children-special-topic.jsp?parentCategoryCode="+parentCategoryCode+"&categoryCode="+categoryCode+"&index=8";
			}
			else
			{
				window.location.href="children.jsp?parentCategoryCode="+parentCategoryCode+"&curindex="+curindex;
			}
		...
		{  
			if(childhoodCenterDVodList.vodDataList[area2.curindex].programType == 1)
			{  
			   window.location.href = "children-single-detail.jsp?programCode="+childhoodCenterDVodList.vodDataList[area2.curindex].programCode+"&contentCode="+childhoodCenterDVodList.vodDataList[area2.curindex].contentCode+"&categoryCode="+childhoodCenterDVodList.vodDataList[area2.curindex].categoryCode;
			}else
			{
			   window.location.href = "children-much-detail.jsp?programCode="+childhoodCenterDVodList.vodDataList[area2.curindex].programCode+"&contentCode="+childhoodCenterDVodList.vodDataList[area2.curindex].contentCode+"&categoryCode="+childhoodCenterDVodList.vodDataList[area2.curindex].categoryCode;
			}
		};    
		...
		{
			 var parentCategoryCode=childhoodCatagoryCenterList.categoryList[area3.curindex].parentCategoryCode;
			 var categoryCode=childhoodCatagoryCenterUpList.categoryList[area1.curindex].categoryCode;
		...
		{  		
			if(childhoodRightUVodList.vodDataList[area4.curindex].programType == 1)
			{
				window.location.href = "children-single-detail.jsp?programCode="+childhoodRightUVodList.vodDataList[area4.curindex].programCode+"&contentCode="+childhoodRightUVodList.vodDataList[area4.curindex].contentCode+"&categoryCode="+childhoodRightUVodList.vodDataList[area4.curindex].categoryCode;				
			}else
			{
				window.location.href = "children-much-detail.jsp?programCode="+childhoodRightUVodList.vodDataList[area4.curindex].programCode+"&contentCode="+childhoodRightUVodList.vodDataList[area4.curindex].contentCode+"&categoryCode="+childhoodRightUVodList.vodDataList[area4.curindex].categoryCode;
			}
		};
		...
		{  
			if(childhoodRightDVodList.vodDataList[area5.curindex].programType == 1)
			{
				window.location.href = "children-single-detail.jsp?programCode="+childhoodRightDVodList.vodDataList[area5.curindex].programCode+"&contentCode="+childhoodRightDVodList.vodDataList[area5.curindex].contentCode+"&categoryCode="+childhoodRightDVodList.vodDataList[area5.curindex].categoryCode;				
			}else
			{
				window.location.href = "children-much-detail.jsp?programCode="+childhoodRightDVodList.vodDataList[area5.curindex].programCode+"&contentCode="+childhoodRightDVodList.vodDataList[area5.curindex].contentCode+"&categoryCode="+childhoodRightDVodList.vodDataList[area5.curindex].categoryCode;
			}
		};
		...
		{	
		 //左侧影片数据绑定
			var childhoodLeftListLength = childhoodLeftList.vodDataList.length;
			if(childhoodLeftListLength>0)
			{
				for(var i=0;i<childhoodLeftListLength;i++){
				  area0.doms[i].setcontent("",childhoodLeftList.vodDataList[i].name,14,true,false);
				  $("area0_img_"+i).src = childhoodLeftList.vodDataList[i].pictureList.poster;
			    };
		   };
		//中间三部影片栏目绑定
		var catagoryCenterUpNameLength = childhoodCatagoryCenterUpList.categoryList.length;
		if(catagoryCenterUpNameLength>0)
		{
			for(i=0;i<catagoryCenterUpNameLength;i++)
			{
				$("area1_txt_"+i).innerHTML=childhoodCatagoryCenterUpList.categoryList[i].name;
			};
			$("themeImage").src =childhoodCatagoryCenterUpList.categoryList[area1.curindex].pictureList.poster;
		}; 
		//中下热播推荐	
		var childhoodCenterDVodListLength=childhoodCenterDVodList.vodDataList.length;
		if(childhoodCenterDVodListLength>0)
		{
			for(var i=0;i<childhoodCenterDVodListLength;i++)
			{
				area2.doms[i].setcontent("",childhoodCenterDVodList.vodDataList[i].name,6,true,false);
				$("area2_img_"+i).src = childhoodCenterDVodList.vodDataList[i].pictureList.poster;
			};			  
		};   
		//中间栏目绑定
		var catagoryCenterNameLength = childhoodCatagoryCenterList.categoryList.length;
		for(i=0;i<catagoryCenterNameLength;i++)
		{
			if(i==0)
			{
				area3.doms[i].setcontent("",childhoodCatagoryCenterList.categoryList[i].name,6,true,false);	
			}
			else
			{
				area3.doms[i].setcontent("",childhoodCatagoryCenterList.categoryList[i].name,8,true,false);
			}
				
		};
		if(catagoryCenterNameLength<10)
	    {
		   var domsLength=area3.doms.length;
		   for(var i=catagoryCenterNameLength;i<domsLength;i++)
		   {
			   $("area3_list_"+i).style.visibility="hidden";			
		   }			
	    }
		//右下主编推荐
		var childhoodRightDVodListLength=childhoodRightDVodList.vodDataList.length;
		if(childhoodRightDVodListLength>0)
		{
			for(var i=0;i<childhoodRightDVodListLength;i++)
			{
				var description=childhoodRightDVodList.vodDataList[i].description;
				$("area5_txt_"+i).innerHTML =description.length>28?description.substr(0,25)+"...":description;
				$("area5_img_"+i).src = childhoodRightDVodList.vodDataList[i].pictureList.poster;
			};			  
		};
		//右上最新上线
		var childhoodRightUVodListLength = childhoodRightUVodList.vodDataList.length;
		for(i=0;i<childhoodRightUVodListLength;i++)
		{
			var name=childhoodRightUVodList.vodDataList[i].name;
			area4.doms[i].setcontent("",childhoodRightUVodList.vodDataList[i].name,12,true,false);
		};			
		 bindata(getDataValue(area7.curpage));
		};
...
<!--head-->
<div class="headline-shade">金色童年</div>
<div class="headline">金色童年</div>
<div class="date">
...
<!--预告片 & Left-->
<div class="txt-title02">炫酷专题</div>
