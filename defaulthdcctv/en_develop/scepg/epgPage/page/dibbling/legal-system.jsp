...
<title>财经- 四川央视概念版高清EPG4.0</title>
<meta name="page-view-size" content="1280*720" />
<link type="text/css" rel="stylesheet" href="../../css/style.css" />
<style type="text/css">
<!--
	body{ background:url(../../images/bg-d05.jpg) no-repeat;}
-->
</style>
...
<script type="text/javascript">
	//左边四部影片
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=legalsysLeftVodCode%>"/> 
		...
		<jsp:include page="<%=strFileCate%>">             
			<jsp:param name="parentCategoryCode" value="<%=legalsysCatagoryCenterUpCode%>" /> 
			<jsp:param name="pageIndex" value="1" /> 
		...
		//中下热播推荐
		<jsp:include page="<%=strfile%>">             
			<jsp:param name="categoryCode" value="<%=legalsysCenterDVodCode%>" /> 
		...
		//右下主编推荐
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=economicsRightDVodCode%>" /> 
		...
		//右上最新上线
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=legalsysRightDVodCode%>" /> 
		...
		//中间下栏目
		<jsp:include page="<%=strFileCate%>">   
			<jsp:param name="parentCategoryCode" value="<%=legalsysCatagoryCenterCode%>" /> 
			<jsp:param name="pageIndex" value="1" /> 
...
window.onload=function()
{
		...
		area3 = AreaCreator(3,4,new Array(2,0,-1,5),"area3_list_","className:item item_focus","className:item");
		...
		area5 = AreaCreator(4,1,new Array(4,2,-1,-1),"area5_list_","className:item item_focus","className:item");
		...
		{	
		  ...
		  //中下热播推荐	
		   ...
		   {			   
			   ...
			   {
				   area2.doms[i].setcontent("",dibblingCenterDVodName.vodDataList[i].name,10,true,false);
		    ...
		    if(catagoryCenterNameLength<12)
			{
			...
			if(dibblingRightDVodNameLength>0)
			{
			   ...
			   { 
				   var name=dibblingRightDVodName.vodDataList[i].name;
				   $("area5_list_"+i).innerHTML =name.length>9?name.substring(0,7)+"...":name;
			   };			  
			};
		   //右上最新上线
...
<div class="wrapper">
	...
	<!--head-->
	<div class="headline-shade">法治空间</div>
	<div class="headline">法治空间</div>
	<div class="date">
	...
	<!--预告片 & Left-->
	<div class="txt-title02">名牌栏目</div>
	...
	<div class="list-h">
		...
		<div class="item" id="area3_list_4" style="top:30px;"><div class="txt" id="area3_txt_4"></div></div>
		<div class="item" id="area3_list_5" style="left:140px;top:30px;"><div  id="area3_txt_5" class="txt"></div></div>
		<div class="item" id="area3_list_6" style="left:280px;top:30px;"><div  id="area3_txt_6" class="txt"></div></div>
		<div class="item" id="area3_list_7" style="left:420px;top:30px;"><div  id="area3_txt_7" class="txt"></div></div>
		
		<div class="item" id="area3_list_8" style="top:60px;"><div  id="area3_txt_8" class="txt"></div></div>
		<div class="item" id="area3_list_9" style="left:140px;top:60px;"><div  id="area3_txt_9" class="txt"> </div></div>
		<div class="item" id="area3_list_10" style="left:280px;top:60px;"><div id="area3_txt_10" class="txt"></div></div>
		<div class="item" id="area3_list_11" style="left:420px;top:60px;"><div id="area3_txt_11" class="txt"></div></div>
	</div>
	...
	<!--list 热点资讯-->
	<div class="txt-title02" style="left:1005px; top:98px;">热点追踪</div>
	...
	<!--list 精彩推荐-->
	<div class="txt-title02" style="left:1005px; top:453px;">精彩节目</div>
	<div class="list-d list-d02" style="top:501px;">
		<!--焦点 
				class="item item_focus"
		-->
