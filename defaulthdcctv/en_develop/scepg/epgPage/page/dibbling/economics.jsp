...
<script type="text/javascript">
	//左边四部影片
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=economicsLeftVodCode%>"/> 
		...
		<jsp:include page="<%=strFileCate%>">             
			<jsp:param name="parentCategoryCode" value="<%=economicsCatagoryCenterUpCode%>" /> 
		...
		//中下热播推荐
		<jsp:include page="<%=strfile%>">             
			<jsp:param name="categoryCode" value="<%=economicsCenterDVodCode%>" /> 
		...
		//右上最新上线
		<jsp:include page="<%=strfile%>">
			<jsp:param name="categoryCode" value="<%=economicsRightUVodCode%>" /> 
		...
		//中间下栏目
		<jsp:include page="<%=strFileCate%>">   
			<jsp:param name="parentCategoryCode" value="<%=economicsCatagoryCenterCode%>" /> 
			<jsp:param name="pageIndex" value="1" /> 
		   ...
		   {			   
			...
			if(dibblingRightDVodNameLength>0)
			{
			   ...
			   { 
				   ...
				   $("area5_list_"+i).innerHTML =name.substr(0,9) ;
			   };			  
			};
		   //右上最新上线
...
<div class="wrapper">
	...
	<!--head-->
	<div class="headline-shade">财经视界</div>
	<div class="headline">财经视界</div>
	<div class="date">
	...
	<div class="list-h">
		...
		<div class="item" id="area3_list_5" style="left:140px;top:30px;"><div class="txt" id="area3_txt_5"></div></div>
		<div class="item" id="area3_list_6" style="left:280px;top:30px;"><div class="txt" id="area3_txt_6"></div></div>
		<div class="item" id="area3_list_7" style="left:420px;top:30px;"><div class="txt" id="area3_txt_7"></div></div>
		
		<div class="item" id="area3_list_8" style="top:60px;"><div class="txt" id="area3_txt_8"></div></div>
		<div class="item" id="area3_list_9" style="left:140px;top:60px;"><div class="txt" id="area3_txt_9"> </div></div>
		<div class="item" id="area3_list_10" style="left:280px;top:60px;"><div class="txt" id="area3_txt_10"></div></div>
		<div class="item" id="area3_list_11" style="left:420px;top:60px;"><div class="txt" id="area3_txt_11"></div></div>
	</div>
	...
	<!--list 热点资讯-->
	<div class="txt-title02" style="left:1005px; top:98px;">热点资讯</div>
	...
	<!--list 精彩推荐-->
	<div class="txt-title02" style="left:1005px; top:453px;">精彩推荐</div>
