...
<%@ include file="datajsp/populardata.jsp"%>
...
<title>人气更多-深圳高清院线专区EPG3.0</title>
...
<script type="text/javascript">
	...
	window.onload=function()
	{
		...
		area0=AreaCreator(1,4,new Array(3,-1,1,-1),"nav0_list_","className:item item_focus","className:item");
				...
				pageDown();
					...
					pageUp();
						...
						if(numString!=""&&numString.charAt(0)!=0&&numString.length<=4&&numString>0&&numString<=area2.pagecount)
						{
							...
							area1.curpage=parseInt(numString);
	...
	function binddata(data){
		//$("nav0_list_3").innerHTML = data[0].VODID;
		...
		if(data[0]!=null){
					   ...
					   {
						 var tempURL = "index_popular.jsp?curentpage=" + curentpage +"&start="+(area2.curpage-1)*9+"&returnurl="+escape(returnurl);
	...
	function pageUp(){
		...
		curentpage -= 1;
		if(curentpage < 1){curentpage = 1;area2.curpage = curentpage;area1.curpage = curentpage;return;}
		area2.curpage = curentpage;
		frame.location.href = "datajsp/populardata.jsp?isFirstFlag=1&start="+(area2.curpage-1)*9;
	...
	function pageDown(){
		...
		curentpage += 1;
		if(curentpage > area2.pagecount){curentpage = area2.pagecount;area2.curpage = area2.pagecount;area1.curpage = area1.pagecount;return;}
		area2.curpage = curentpage;
		frame.location.href = "datajsp/populardata.jsp?isFirstFlag=1&start="+(area2.curpage-1)*9;
...
<!--head title-->	
	<div class="pic" style="left:71px; top:104px;"><img src="images/title01.png" /></div>
<!--head title the end-->		
