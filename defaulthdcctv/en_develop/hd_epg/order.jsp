...
<%
   ...
   if(sProgId!=sFatherSeriesId){
	...
	if(posterMap!=null){
		...
		picUrl = "../"+getPosterPath(posterMap,"images/demopic/pic-173X231.jpg","1",request);
	}
...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		if(<%=isAllowPPV%>==0){
			area0.datanum = 0;
			$("canppv").style.display = "none";
			$("cannotppv").style.display = "block";
			$("ppvback").style.display = "none";
...
<body>
	...
	<!-- S 左侧海报 -->
    <div class="j-postTitle"><%=tempvodname%></div>
    <div class="j-postPic"><img src="<%=picUrl%>" width="333px;" height="441px" /></div>
	
	<div class="order-new" style="left:402px; top:172px;display:block" id="canppv">
    ...
    <div class="order-new" style="left:402px; top:172px;display:none" id="cannotppv">
		<div class="txt txt04" style="font-size:22px;width:190px;left:122px" >暂不支持单片订购</div>
    </div>
    <div class="btn-c" style="left: 457px; top: 435px;display:block" id="ppvback">
		<!--焦点 
