	...
	window.onload=function()
	{
		...
		if(focusObj!=undefined&&focusObj!="null"){
			   ...
			   indexid = parseInt(focusObj[0].curindex);
                ...
                area6=AreaCreator(1,2,new Array(-1,-1,0,-1),"jifen_","className:item item_focus","className:item");
				area6.doms[0].mylink = "order-monthly3.jsp?returnUrl="+escape(window.location.href);
                area6.doms[1].mylink = "../jifen/index.jsp?returnUrl=../hd_epg/HD_index.jsp";
