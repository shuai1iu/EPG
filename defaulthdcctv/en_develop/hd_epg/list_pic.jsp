...
<script type="text/javascript">
	...
	window.onload=function()
	{
		...
		area0=AreaCreator(1,8,new Array(4,-1,1,-1),"nav0_list_","className:item","className:item");
		...
		if(focusObj!=undefined&&focusObj!="null"){
		 ...
		 area4=AreaCreator(1,2,new Array(-1,-1,0,-1),"jifen_","className:item item_focus","className:item");
				area4.doms[0].mylink = "order-monthly3.jsp?returnUrl="+escape(window.location.href);
                area4.doms[1].mylink = "../jifen/index.jsp?returnUrl=../hd_epg/HD_index.jsp";
		pageobj=new PageObj(areaid,indexid,new Array(area0,area1,area2,area3,area4),null);
		pageobj.backurl = returnurl;
