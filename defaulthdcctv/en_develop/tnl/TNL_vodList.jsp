...
<style>
	...
	.lable{position:absolute; width:60px; height:31px; left:0px; top:0px; font-size:22px; text-align:center; line-height:31px; background:url(images/line.png) no-repeat right;}
...
<img src="images/dot.gif" width="113" height="55"/></a></div>

<div style="position:absolute; width:600px; height:50px; left:22px; top:50px;">
 <!-- <div id="nav_0" class="nav"><img src="images/category/wz_0.png" width="69" height="28" style="position:absolute; left:20px; top:11px;"/></div>-->
...
<div id="input0" style="top:108px;" class="input"></div>
<div id="input1" style="top:465px;" class="input"></div>

<div id="pageNum0" class="pagenum" style="top:111px;"></div>
...
function init()
{
	...
	if(vodList.length > 0)initPlayVod(currPlayVod);
        document.body.style.backgroundImage = "url(images/list/vodList_bg.png)";
}
function gotoHome()
{
