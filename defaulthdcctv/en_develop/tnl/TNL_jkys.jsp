...
<title>健康饮食</title>
<style>
	.input{position:absolute; width:52px; height:32px; left:333px; text-align:center; font-size:20px; line-height:30px;}
	...
	.poster_bg{position:absolute; width:290px; height:176px; background:url(images/jkys/poster_bg.png); display:none;}
...
<a id="but_focus_0" href="#" onClick="keyPageDown()" style="left:25px; top:113px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
<a id="but_focus_1" href="#" onClick="keyPageUp()" style="left:104px; top:113px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
<a id="but_focus_2" href="#" onClick="keyBack()" style="left:183px; top:113px;" class="button"><img src="images/dot.gif" width="76" height="30"/></a>
...
<a id="input_focus0" href="#" class="input" style="top:112px;" onFocus="changeInputObj('input0')" onKeyPress="keyInput()"><img src="images/dot.gif" width="52" height="32"/></a>
