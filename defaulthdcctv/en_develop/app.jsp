...
<%
	...
	ArrayList appResult=new MyUtil(request).getVasListData("10000100000000090000000000033990",6);
	System.out.println("===========appResultData===="+appResult);
	Object temp = appResult.get(0);
	System.out.println("===========appResultDDDData===="+temp);
...
ArrayList tmpimgVas=(ArrayList)metadata.getVasListByTypeId("10000100000000090000000000033990", 6, 0);
 ...
 function getdata(data)
{
		...
		for(i=0;i<area1.doms.length - 1;i++)//-1ÒªÈ¥µô
                {
			...
			if(i<area1.datanum)
			{
				...
				//	area1.doms[i].vasname=data[i].VASNAME;
...
<div class="main">
	...
	<div class="menu"> <!--ç„¦ç‚¹ä¸º class="menuli on"  å½“å‰é€‰ä¸­ä¸º class="menuli current"-->
	    ...
	    <div class="menuli" id="area0_list_3" style="top:166px"><img src="images/icon_3new.png" />ä¸“  é¢˜</div>
