...
<script language="javascript" type="text/javascript">
	...
	var AjaxReturn = -1;
	var isComFromHD = <%=request.getParameter("isComFromHD")==null?0:Integer.parseInt(request.getParameter("isComFromHD"))%>;//czc  20131223   进入回放的上一个页面标识
	var tempchannelNumber;  //czc  20131223    获取当前播放频道号，用于返回
    ...
    function initPage()
	 {
	   ...
	   area1.changefocusingEvent=function()
	   {
		...
		if(isComFromHD==0)  //czc 20131227  回放返回的路径，如有是从央视精品专区过来，则返回到央视精品专区，如果不是，则返回到回放频道列表
		{
