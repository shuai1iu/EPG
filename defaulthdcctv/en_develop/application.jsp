...
{
    $("log_frame").src = "http://219.133.42.99:8080/userBehavior/visitLog.jsp?userID=234";
    ...
    if(groupid == 1232)
    {
	    appShowName = "å…‰æ˜ç¿ æ¹–ç¤¾åŒº";
            industryAppUrl = "http://14.29.1.13:8082/epg/login!index.action?tradeId=1232"+"&itvUserId=" + userid_str+ "&endUrl=" + basePath;
	    getdata(applist);
	   getdata_trade();
    }else
    {
...
<iframe id="log_frame" style="display:none;width:1px;height:1px;"></iframe>
