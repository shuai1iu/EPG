...
.channel_choose{ position:absolute;left:0px top:0; background:url(playerimages/channel_OSD_lbg.png) repeat-y; width:405px; height:720px;}
.sub{ height:46px; line-height:46px; padding-left:35px}
.on{ background:url(playerimages/channel_sub2on.png) no-repeat;padding-left:35px; height:46px;;line-height:46px; }
</style>
</head>
...
function changeAudio()
{
	...
	switch(audio)
	{
		case 0:$("voice").src="playerimages/leftvoice.png";break;
		case 1:$("voice").src="playerimages/rightvoice.png";break;
		case 2:$("voice").src="playerimages/centervoice.png";break;
		default:break;
	}
...
function genVolumeTable(volume)
{
	...
	tableDef += '<td width="20px"></td><td width="40px"><img src="playerimagescontrol/volume.gif"></td><td width="40px" style="color:white;font-size:28">' + volume + '</td>';
	tableDef += '</tr></table>'; 
...
function checkSeeking()
{
	if(isSeeking == 0){clearTimeout(timeID_check);timeID_check = "";}
		...
		{
			$("statusImg").innerHTML = '<img src="playerimages/pause.png" width="40" height="40"/>';
		}
		var inputValueHour = $("jumpTimeHour").value;
		var inputValueMin = $("jumpTimeMin").value;
...
function displaySeekTable()
{
	...
	if(isSeeking == 0){
		...
		//$("statusImg").innerHTML = '<img src="playerimagescontrol/playChannel/pause.png" width="40" height="40"/>';
...
{    	
	...
	speed = speed * 2;
	$("statusImg").innerHTML = '<img src="playerimages/fastRewind.png" width="20" height="20"/>&nbsp;X' + speed; 
	mp.fastRewind(-speed);  
    playStat = "fastrewind"; 
}
//快进
...
{ 		    
	...
	speed = speed * 2;
	$("statusImg").innerHTML = '<img src="playerimages/fastForward.png" width="20" height="20"/>&nbsp;X'+speed;
...
{	
	...
	if(backUrl.indexOf('?')==-1){backUrl+="?back=1";}	    
	 ...
	 var pkbackUrl = getURLtoCookie("channelPlay");
...
{		
	var chaninfo = "";
	if(currListPage>0){
		chaninfo = "<div align='center'><img src='playerimages/up.png'/></div>";
	}else{
		 chaninfo = "<div align='center'><img src='playerimages/up_gray.png'/></div>";
	}
	for(var j = 0; j<rows; j++)
	{
		...
		chaninfo+="<div><img src='playerimages/menu_line.png'/></div>";
	}
	if(currListPage<totalListPages-1){
		chaninfo += "<div align='center'><img src='playerimages/down.png'/></div>";
	}else{
		 chaninfo += "<div align='center'><img src='playerimages/down_gray.png'/></div>";
	}
...
<a id="currentTime" href="#" style="width:1px; height:1px; top:0px; left:0px;"><img src="playerimages/dot.gif" width="1" height="1"/></a>
</div>
<!--数据封装-->
<div id="filmInfoDB">
...
<div id="seekDiv" style="position:absolute;width:1280px;height:200px;left:0px;top:408px; z-index:1;display:none;">
  ...
  <!--进度点-->
  <div id="currentTime_progress" style="position:absolute;left:345px;top:172px;width:23px;height:20px; z-index:1; background:url(playerimages/chanMini_lostTimePro.png);"></div>
  <!-- 进度条所在div -->
  <div style="position:absolute; background:url(playerimages/control_bbg.png) repeat-x; width:100%; height:237px;left:0;top:80;z-index:-1;"></div>
...
<img src="playerimages/noOrder.jpg" border="0" width="350px" height="135px" /> </div>
...
<div id="errorBackGround" style="position:absolute; left:150x; top:100px; width:350px; height:80px; z-index:-1; display:none">
 <img src="playerimages/bg-seek.gif" border="0" width="350px" height="80"> </div>
<!--系统错误提示-->
<div id="errorDiv" style="position:absolute; left:120px; top:315px; width:400px; height:70px; z-index:1;display:none"> <img src="playerimages/jumpDivBack.gif" width="400px" height="70px"/> </div>
...
<img src ="playerimages/chanMini_lostTimePro.png"/>
<img src ="playerimages/chanMini_timePro.png"/>
<img src ="playerimages/up.png"/>
<img src ="playerimages/down.png"/>
<img src ="playerimages/up_gray.png"/>
<img src ="playerimages/down_gray.png"/>
</div>
</body>
</html>
