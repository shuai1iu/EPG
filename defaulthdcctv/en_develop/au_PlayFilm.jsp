...
<%-- 
	本页面用于判断媒体是个否存在及判断是否有父母锁的存在，没有直接进入页面授权，有父母锁走父母锁流程
--%>
...
<%	
	...
	System.out.println("AU_playFilm_request="+(String)request.getQueryString());
	...
	else  
	{
		...
		System.out.println("AUTHORIZATION_request="+request.getQueryString());
	...
	%>
		...
		<tr>
		<td align="center" style="font-size:36px;color:#FFFFFF; font-family:黑体">验证及父母锁处理中. 请稍候...<%=pageName%></td>
		</tr>
		</table>
		</body>	
		</html>
