...
xml += '<response_type>0</response_type>'; //0:stb  1:EPG 2:?
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/dibbling.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_TVOD_MENU</key_code>';     //点播地址
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/playback.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';			//直播频道地址
xml += '<key_code>KEY_TV_MENU</key_code>';
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/channel.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_RED</key_code>';     //红色键定义
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/index.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_GREEN</key_code>';	//绿色键定义
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/playback.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_YELLOW</key_code>';	//黄色键定义
xml += '<response_type>2</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/dibbling.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_BLUE</key_code>';		//蓝色键定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/defaulthdcctv/en_develop/space_collect.jsp</service_url>';
xml += '</response_define>';
xml += '<response_define>';
