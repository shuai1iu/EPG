...
<%
   ...
   if(sProgId!=sFatherSeriesId){
	...
	if((temptimeList==null  ||  temptimeList.size()==0) && (tempmouseList==null  ||  tempmouseList.size()==0)){
	...
	<script type="text/javascript">
		...
		window.onload = function(){
			if(<%=isAllowPPV%>==1){
			    ...
			    area1=AreaCreator(1,1,new Array(-1,0,-1,-1),"area1_list","className:item item_focus","className:item");
			...
			<% }%>
			$("area1_list1").style.background = "url(../images/lostPPVBuy.png) center top no-repeat";
		}
    </script>
</head>
<body>
<div class="wrapper">
    ...
    <div class="j-recommend j-recommendA">
        ...
        <div class="j-btnA">
            <div class="item" id="area1_list1"><div class="txt"></div></div>
        </div>
    </div>
