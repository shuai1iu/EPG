...
function checksubscribe(jsonResult)
{
	...
	if(jsonResult.ALLOWPLAY==false)
	{
	   ...
	   var pageName="check/page/buy_discount.jsp?SUBJECTID=<%=typeid%>&VODID=<%=vodid%>&FATHERID=<%=vodid%>&PLAYTYPE=1&CONTENTTYPE="+datalist[0].CONTENTTYPE+"&BUSINESSTYPE=1&returnurl="+escape(location.href)+"&playurl="+escape(playname);
