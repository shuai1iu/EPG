...
window.onload = function(){
	...
	//area2.doms[5].mylink = "../../au_PlayFilm.jsp?PLAYTYPE=1&CONTENTTYPE=0&INITFLAG=1&RRETURNFLAG=1&BUSINESSTYPE=1&ISVIP=1&PROGID=1659159&FATHERSERIESID=1659590&backurl=/EPG/jsp/defaulthdcctv/en_develop/SZ_EPG/page/index.jsp";
//	area2.doms[5].mylink ="check/page/packages.jsp";
        area2.doms[5].mylink = "../../activity/page/activityConfig.jsp?TARGETURL=escape(%27http://219.133.42.109:1137/VasPGOrder/page/once-buy.jsp%27)&pageId=0&returnurl=SZ_EPG/page/index.jsp";
