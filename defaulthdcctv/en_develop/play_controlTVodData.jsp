...
<%
	...
	strIntro = (null == strIntro)?"暂无介绍":subStringFunction(strIntro,2,640);
    ...
    else
    {
        ...
        channelName = subStringFunction(tmpChannelName,1,190);
    }
    ...
    if(null != tmpprog)
    {
        ...
        for(int i = 0; i < progSize; i++)
        {
            ...
            progStartTime[i] = tmpStartDate + tmpStartTime;  //传参
            progEndTime[i] = tmpEndtDate + tmpEndTime; //传参
        ...
        for(int j = 0; j < progSize; j++)
        {
            if(progId.equals(progIds[j]))
            {
                //当前节目信息
                currIndex = j;
                progName = subStringFunction(progNames[currIndex],1,190);
        ...
        else
        {
            ...
            preProgName = subStringFunction(progNames[currIndex - 1],1,190);
        ...
        else
        {
            ...
            nextProgName = subStringFunction(progNames[currIndex + 1],1,190);
...
{	
	...
	parent.progTimeBegin = progTimeBegin;//演员
