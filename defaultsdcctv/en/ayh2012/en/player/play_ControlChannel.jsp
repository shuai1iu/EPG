...
/*play*/
.play-page {
	background:url(playerimages/play-page-bg.png) repeat-x;
	height:131px;
	line-height:35px;
	left:0; 
	position:absolute; 
...
.progress-bar {
	background:url(playerimages/progress-barbg.png) no-repeat;
	height:35px;
	left:169px; 
	position:absolute; 
	top:17px;
...
.progress-bar .bar div.b1 { background:url(playerimages/progress-bar-l.png) no-repeat;}
.progress-bar .baron div.b1 { background:url(playerimages/progress-baron-l.png) no-repeat;}
.progress-bar .bar div.b2 { background:url(playerimages/progress-bar.png) right no-repeat;}
.progress-bar .baron div.b2 { background:url(playerimages/progress-baron.png) right no-repeat;}

.progress-bar2 {
	background:url(playerimages/progress-barbg2.png) no-repeat;
	height:35px;
	left:375px; 
	position:absolute; 
	top:14px;
...
.progress-bar2 .bar div.b1 { background:url(playerimages/progress-bar-l.png) no-repeat;}
.progress-bar2 .baron div.b1 { background:url(playerimages/progress-baron-l.png) no-repeat;}
.progress-bar2 .bar div.b2 { background:url(playerimages/progress-bar.png) right no-repeat;}
.progress-bar2 .baron div.b2 { background:url(playerimages/progress-baron.png) right no-repeat;}
...
.set-time .inp,.set-time .inpon {
	background:url(playerimages/inp-bg.png) no-repeat;
	color:#fff;
...
.set-time .inpon {
	background:url(playerimages/inp-bgon.png) no-repeat;
}
.btn-operate {
	left:500px; 
	position:absolute; 
...
.volume {
	background:url(playerimages/volume-bg.png) no-repeat;
	height:45px;
	line-height:45px;
	left:102px; 
	position:absolute; 
...
.volume div.on{
	background:url(playerimages/volume-bgon.jpg) repeat-x;
...
function initMediaPlay()
{
    ...
    var randomFlag = 0;
    var autoDelFlag = 0;
    mp.initMediaPlayer(instanceId,playListFlag,videoDisplayMode,0,0,0,0,muteFlag,useNativeUIFlag,subtitleFlag,videoAlpha,cycleFlag,randomFlag,autoDelFlag);
}
function init()
{
	setSTB();
...
function goUtility()
{
	...
	{  
		...
		case "EVENT_MEDIA_BEGINING":
			$("seekDiv").style.display = "none";isSeeking = 0;speed = 1;jumpDivIsShow = false;seekDivIsShow = false;resumestat();return false;
...
{	
	...
	$("statusImg").innerHTML = '<img src="playerimages/btn-pause.png"/>';
	$("speed").innerHTML = '';
	if("false" == channelListFlag){hiddenChannelList();}
}
...
{    
	if(0==isSeeking){
		...
		displaySeekTable();
		$("statusImg").innerHTML = '<img src="playerimages/icon-fast-return.png"/>';
	...
	if(playStat != "fastrewind"){$("statusImg").innerHTML = '<img src="playerimages/icon-fast-return.png"/>';playStat = "fastrewind"; }
...
{ 		
   if(0==isSeeking){
	   if(0==pltvStatus[currChannelIndex]|| 0== shiftFlag||"true"==mediaErrorFlag || "true" ==lockFlag|| "true"==isNotSubFlag){ return 0;} 
		...
		$("statusImg").innerHTML = '<img src="playerimages/icon-fast-enter.png"/>';
		if(volumeDivIsShow){hideBottom();}
		if("false" == channelListFlag){hiddenChannelList();}
		if("true" == infoFlag){hiddenFilmInfo();}
		//$("jumpTimeDiv").style.display = "none"; 
   ...
   if(playStat != "fastforward"){$("statusImg").innerHTML = '<img src="playerimages/icon-fast-enter.png"/>';playStat = "fastforward";}         	
...
function resetPara_seek()
{
	...
	$("jumpTimeMin").innerText = "";
	$("timeError").innerHTML = "";
	if(playStat=="play"){$("statusImg").innerHTML = '<img src="playerimages/btn-pause.png"/>';}
	else if(playStat=="fastrewind") {$("statusImg").innerHTML = '<img src="playerimages/icon-fast-return.png">';}
	else{$("statusImg").innerHTML = '<img src="playerimages/icon-fast-enter.png">';}
}
...
{
	if(playStat != "fastrewind" && playStat != "fastforward"){$("statusImg").innerHTML = '<img src="playerimages/btn-pause.png"/>';}
...
function loadData()
{
	...
	//parent.joinChannel(currChannelNum);
}	
//向下键
function arrowDown()
{
...
function realCurrPage()
{
	...
	else{currListPage = getInt(chanListFocus / rows);}
}	
//直播列表层显示
...
<%--直播节目单OSD------------------------------------------%>
<div id="filmInfo1" style="position:absolute; left:420px; top:0px; width:360px; height:530px;display:none;z-index:97;">
...
<div id="seekDiv" class="play-page" style="position:absolute;width:640px;height:150px;left:5px;top:400px; z-index:1;display:none">
    ...
    <div id="timeError" style="position:absolute;width:220px;height:23px;left:55px;top:42px; z-index:2;font-size:18px;color:#FF3"></div>
...
<!--右上方时移图标-->
	<div id="shift" style="display:none;" class="btn-operate"><img src="playerimages/icon-time-shifting.gif" /></div>
<!--右上方时移图标-->
...
<div style="position:absolute; left:15px; top:15px; width:54px; height:66px; z-index:3;"><img id="voice" src="#"/></div>

<div style="visibility:hidden;">
<img src ="playerimages/icon-time-shifting.gif"/>
<img src ="playerimages/volume-bgon.jpg"/>
<img src ="playerimages/t.gif"/>
<img src ="playerimages/live-pop-bg.png"/>
<img src ="playerimages/icon-fast-return.png"/>
<img src ="playerimages/icon-fast-enter.png"/>
<img src ="playerimages/play-page-bg.png">
<img src ="playerimages/progress-barbg.png">
<img src ="playerimages/progress-bar.png">
<img src ="playerimages/progress-baron.png">
<img src ="playerimages/progress-barbg2.png">
<img src ="playerimages/progress-bar-l.png">
<img src ="playerimages/progress-baron-l.png">
<img src ="playerimages/volume-bg.png">
<img src ="playerimages/btn-pause.png">
</div>
</body>
