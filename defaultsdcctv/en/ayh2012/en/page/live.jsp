...
<div class="live-sort">
	...
	<div class="item" id="item_4" style="top:156px;">
		<div class="link"><a id="chan_a_4" href="#" onclick="playChannel(404)" >
        <img src="<%=static_url%>/images/t.gif" /></a></div>
	</div>
    <div class="item" style="top:156px;">
        <div class="txt" id="channel_4">高尔夫网球</div>
	</div>
	<div class="item" id="item_5" style="top:195px;">
		<div class="link"><a id="chan_a_5" href="#" onclick="playChannel(402)">
        <img src="<%=static_url%>/images/t.gif" /></a></div>
	</div>
    <div class="item" style="top:195px;">
        <div class="txt" id="channel_5">金牌赛事</div>
	</div>
	<div class="item" id="item_6" style="top:234px;">
		<div class="link"><a id="chan_a_6" href="#" onclick="playChannel(403)">
        <img src="<%=static_url%>/images/t.gif" /></a></div>
	</div> 
    <div class="item" style="top:234px;">
        <div class="txt" id="channel_6">中国之队</div>
	</div> 
	<div class="item" id="item_7" style="top:273px;">
		<div class="link"><a id="chan_a_7" href="#" onclick="playChannel(401)">
        <img src="<%=static_url%>/images/t.gif" /></a></div>
	</div>
    <div class="item"  style="top:273px;">
        <div class="txt" id="channel_7">奥运综合</div>
	</div> 
