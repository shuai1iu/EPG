...
<script type="text/javascript">
   ...
   {   
	   ...
	   area0=AreaCreator(1,6,new Array(4,-1,1,-1),"area0_list_","afocus","ablur");
	   ...
	   area0.doms[5].mylink="package.jsp?returnurl="+returnurl;

	//  area0.doms[5].mylink="html/page/activityindex.jsp?returnurl="+returnurl;

	   area1=AreaCreator(4,2,new Array(0,6,2,5),"area1_list_","afocus","ablur");
	   ...
	   area5=AreaCreator(1,1,new Array(0,1,7,6),"area5_","afocus","ablur");

	   area5.doms[0].imgdom=$("area5_img_0");

	   area5.stablemoveindex=new Array("0-2","0-1",-1,-1);
	   ...
	   pageobj=new PageObj(backfocus!=null?backfocus[0].areaid:0,backfocus!=null?backfocus[0].curindex:0,new Array(area0,area1,area2,area3,area4,area5,area6,area7));

	    //area5.doms[0].mylink="play_ControlChannel.jsp?CHANNELNUM=<%=shouyezhibo%>&COMEFROMFLAG=1&returnurl="+escape(location.href);
	    area5.doms[0].mylink="ayh2012/en/page/index.jsp?returnurl="+escape(location.href);
	     //area5.doms[0].mylink="../../../defaultsdzhuanti/ayh2012/en/page/index.jsp?returnurl="+escape(location.href);

	   //area5.doms[0].mylink="PlayTrailerInVas.jsp";
		...
		for(i=0;i<area.doms.length;i++)

			{
...

			   {
				   ...
				   area.doms[i].setcontent("",data[i].VASNAME,4,true,true);
   ...
   function load_iframe()

	{
...

		{
			...
			document.getElementById("mid_play").src = (picpath!=null&&picpath!=""&&picpath!="absolute")?picpath:"../images/ozb-28210.jpg";
...
<div class="wrapper">
    ...
    <div class="mod-index-recommend">
        ...
        <div class="item" style="left: 29px; top: 139px;">
        ...
        <div class="item" style="left: 100px; top: 139px;">
