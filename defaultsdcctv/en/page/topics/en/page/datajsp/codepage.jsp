...
<%!
	...
	//首页热词CODE
	final static String Index_Hotkey = "00000100000000090000000000019681"; //00000100000000090000000000019681
	
	//首页推荐
	final static String Index_Recommend = "00000100000000090000000000019651";  //00000100000000090000000000019711
	

	final static String Index_Recommend1 = "00000100000000090000000000019651";
	
	//首页精彩回放
	final static String Index_Besttvod = "00000100000000090000000000019711";
	
	//点播页面推荐 及 详情页
	final static String Vod_Recommend="00000100000000090000000000019711";
