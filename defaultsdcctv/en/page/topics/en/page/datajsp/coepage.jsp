...
<%!
	...
	//首页推荐
	final static String Index_Recommend = "00000100000000090000000000019651";	    
	
	final static String Index_Recommend1 = "00000100000000090000000000019651";
	
	//首页精彩回放
	final static String Index_Besttvod = "00000100000000090000000000019710";
	
	//点播页面推荐 及 详情页
	final static String Vod_Recommend="00000100000000090000000000019710";
