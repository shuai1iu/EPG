...
function loadBody() {
    ...
    area0.doms[0].focusstyle=new Array("className:item item_select onboder");
	area0.doms[0].unfocusstyle=new Array("className:item item_select offboder");
	...
	area0.doms[5].mylink="space_installed.jsp?areaid=1&indexid=5";
...
function showTj(data){
	...
	{    
		...
		if(i<data.length) 
	    {
		   ...
		   area3.doms[i].mylink="vod-tv-detail.jsp?vodid="+data[i].VODID+"&typeid=<%=shoucangcode%>"+"&returnurl="+escape("space_collect.jsp?curpage="+area2.curpage+"&indexid="+i+"&areaid=3");
...
function OkFun()
{   
    window.location.href="vod-tv-detail.jsp?vodid="+collentList[pageobj.getfocusindex()].progId +"&returnurl="+escape("space_collect.jsp?curpage="+area2.curpage+"&areaid=2&indexid="+pageobj.getfocusindex());
}
