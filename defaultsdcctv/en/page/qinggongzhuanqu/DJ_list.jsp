...
<style>
	...
	.nav_focus{position:absolute; width:113px; height:30px; left:0px; top:1px;}
	.poster_focus{position:absolute;width:108px;top:383px;height:109px;}
	.list_focus{position:absolute; width:331px; height:30px; left:0px; display:none;}
	.list{position:absolute; width:333px; height:35px; left:3px; display:none;}
	.name{position:absolute;width:324px;height:30px;left:15px;top:0px;color:#ffebcd;font-size:20px;line-height:35px; overflow:hidden;}
	.button{position:absolute; width:76px; height:30px;}
	.pagenum{position:absolute;width:55px;height:25px;left:392px;line-height:30px;line-height:30px;font-size:25px;color:#ffebcd;}
	.input{position:absolute; width:52px; height:28px; left:300px; text-align:center; font-size:20px; line-height:28px;color:#ffebcd;}
</style>
</head>
...
<img id="downImg_0" src="images/pagedown.png" width="73" height="26" style="left:27px; top:125px; position:absolute"/>
<img id="upImg_0" src="images/pageup.png" width="73" height="26" style="left:106px; top:125px; position:absolute"/>
<img id="downImg_1" src="images/pagedown.png" width="73" height="26" style="left:27px; top:476px; position:absolute"/>
<img id="upImg_1" src="images/pageup.png" width="73" height="26" style="left:106px; top:476px; position:absolute"/>
<img src="images/back.png" width="73" height="26" style="left:185px; top:125px; position:absolute"/>
<img src="images/back.png" width="73" height="26" style="left:185px; top:476px; position:absolute"/>

<a id="pageDown_focus_0" href="#" onClick="keyPageDown()" style="left:23px; top:120px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>
<a id="pageUp_focus_0" href="#" onClick="keyPageUp()" style="left:104px; top:120px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>
<a href="#" onClick="keyBack()" style="left:183px; top:120px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>

<a id="pageDown_focus_1" href="#" onClick="keyPageDown()" style="left:23px; top:473px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>
<a id="pageUp_focus_1" href="#" onClick="keyPageUp()" style="left:104px; top:473px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>
<a href="#" onClick="keyBack()" style="left:183px; top:473px;" class="button"><img src="images/dot.gif" width="80" height="37"/></a>
...
<div id="currNavName" style="position:absolute; width:240px; height:30px; top:373px; left:398px; z-index:-1;line-height:30px; color:#ffebcd; font-size:15px; overflow:hidden;"></div>

<a id="input_focus0" href="#" class="input" style="top:122px;" onFocus="changeInputObj('input0')" onKeyPress="keyInput()"><img src="images/dot.gif" width="55" height="38"/></a>
<a id="input_focus1" href="#" class="input"  style="top:473px;"onFocus="changeInputObj('input1')" onKeyPress="keyInput()"><img src="images/dot.gif" width="55" height="38"/></a>

<div id="input0" style="top:125px;" class="input"></div>
<div id="input1" style="top:477px;" class="input"></div>

<div id="pageNum0" class="pagenum" style="top:122px;"></div>
<div id="pageNum1" class="pagenum" style="top:475px;"></div>

<div style="position:absolute; width:360px; height:273px; left:23px; top:165px;">
...
<a id="media_focus" href="#" onClick="playVod(currPlayVod%pageSize,true);" style="position:absolute;left:370px; top:163px;"><img src="images/dot.gif" width="258" height="218"/></a>
<!--</div>-->
<div style="position:absolute; width:340px; height:293px; left:24px; top:163px;">
  ...
  <img src="images/dot.gif" width="336" height="38"/></a>
  <a id="focus_1" href="#" class="list_focus" style="top:38px;" onClick="playVod(1)">
  <img src="images/dot.gif" width="338" height="38"/></a>
...
var currNavName = ["焦点动态","城市课堂","圆梦行动","秀我风采"];
...
function playVod(index,flag)
{
	...
	else
	{
		...
		backurl = "qinggongzhuanqu/DJ_list.jsp?column="+column+"&PREFOUCS="+focusObj+","+currPage+","+currPlayVod;
...
function previewVod(dataIndex)
{
   for(var i=pageSize*currPage; i<(currPage+1)*pageSize; i++)
	...
	currPlayVod = dataIndex;
        $("name_"+dataIndex%pageSize).innerHTML = "<marquee behavior='scroll' height='42' width='90%' startposition='90%'>"+vodList[dataIndex].vodName+"</marquee>";
...
function initMediaPlay()
{
	...
	mp.setVideoDisplayArea(375,162,250,210);
