...
<%@ include file="../../../defaultgdsd/en/page/shouying/page/check_subscribedata.jsp"%>
<%@ include file="../../../defaultgdsd/en/page/shouying/page/util_getPosterPaths.jsp"%>
...
<link type="text/css" rel="stylesheet" href="../../../defaultgdsd/en/page/shouying/css/styleorder.css" />

<script type="text/javascript" src="../../../defaultgdsd/en/page/shouying/js/pagecontrol.js"></script>
...
window.onload = function(){
	...
	area0.doms[0].domOkEvent = function(){
		window.location.href="../../../defaultgdsd/en/page/shouying/page/order-monthly.jsp?price=<%=zxprice%>&ppvsj=<%=ppvsj%>&prodname=<%=zxname%>&prodid=<%=zxcode%>&serverid=<%=zxservicecode%>&vodid=<%=sProgId%>&parentvodid=<%=fatherSeriesId%>&url1="+escape(window.location.href)+"&playurl="+escape("<%=playurl%>");
	}
	area0.doms[1].domOkEvent = function(){
		window.location.href="../../../defaultgdsd/en/page/shouying/page/order-pay.jsp?isppv=1&price=<%=ppvprice%>&ppvsj=<%=ppvsj%>&prodname=<%=ppvname%>&prodid=<%=ppvcode%>&serverid=<%=ppvservicecode%>&vodid=<%=sProgId%>&parentvodid=<%=fatherSeriesId%>&url1="+escape(window.location.href)+"&playurl="+escape("<%=playurl%>");
	}
...
<!--pagebg-->
<div class="pagebg">
<div class="pic"><img src="../../../defaultgdsd/en/page/shouying/images/bg-order01.jpg" width="640" height="530" /></div>
</div>
<!--pagebg the end-->
...
<div class="txt txt01" style="top:48px;font-size:25px" id="title_ppv"><%=ppvname%> <%=ppvprice%> 元</div>
<div class="line"><img src="../../../defaultgdsd/en/page/shouying/images/line.png" width="332" height="2" /></div>
