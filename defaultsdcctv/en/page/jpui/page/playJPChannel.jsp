...
<%
	...
	ArrayList tuijianvodlist = (ArrayList)metaData.getVasListByTypeId("10000100000000090000000000042211",2,0);
...
body, div, button, input, select, textarea { font-size: 18px; font-family: Microsoft YaHei,SimHei,sans-serif; line-height: 100%; }
...
/* =S Global
----------------------------------------------- */
.item, .link, .txt-wrap, .txt, .btn, .icon, .pic, .pic-shade, .num, .win { 
	 left: 0; 
	 position: absolute;
	 top: 0;
}
...
.nav .btn {
	background:url(../images/nav-bg02_focus.png) no-repeat;
	color:#fff;
	font-size:20px;
	text-align:center;
	line-height:36px;
...
<script  type="text/javascript">
		...
		window.onload=function(){
			  ...
			  tempShowMsgTimer = setTimeout("hiddenChannnum();", 4000);
			  goblanktimer=setTimeout("goBlank()",4000);
    ...
    var area3={selectindex:0,curindex:0,stadyindex:0,datanum:1,curpage:1,pagenum:1};
  ...
  area3.ok=function(){
	  var tempurl = "../../../../../"+vaslist[0].VARSURL//2014/1/27
...
<!--pagebg the end-->
<div id="topframe" style="position:absolute;left:300px; top:8px; width:200px; height:30px; z-index:1;display:none">
...
<div class="wrapper">
	...
	<div class="hd-left">
		...
		<div class="nav">
			...
			-->
			<div id="divchannel0" class="item" style="top:3px;">
	...
	<div class="list-warp" id="divtvodlist" style="display:none">
		<div class="btn btn-up">
			<!--焦点 
					class="item item_focus"
			-->
			<div id="pageUp" class="item item_focus"></div>
		</div>
		...
		<div class="btn btn-down">
			<!--焦点 
					class="item item_focus"
			-->
			<div id="pageDown" class="item item_focus"></div>
		</div>
