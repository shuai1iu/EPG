...
<div class="dibbling-sub"> <!--默认为 class="item" , 当前选中为 class="item item-select"-->
	...
	<div class="item item-select" style="left:190px;" id="match1">
