...
function keypress(keyval)
{
	switch(keyval)
	{
	 ...
	 /* case <%=KEY_VOL_UP%>:
		...
		case <%=KEY_INFO%>:pressOk();return;return 0;
...
{	
	...
	{
		//var currTime = parseInt(mp.getCurrentPlayTime()) + parseInt(count*60);//20120524 for move cannot playByTime
...
{
	if(isSeeking == 1){beginTime = tempCurrTime;}
	var type = 1,speed = 1;
	playStat = "play";
	currTime = mp.getCurrentPlayTime();
...
{
	if(isSeeking == 0){		   
		displaySeekTable(1);clearTimeout(timeID_jumpTime);timeID_jumpTime = "";isJumpTime = 0;	
...
{
	//alert(quitDivIsShow+"/"+finishedDivIsShow+"/"+jumpToChannelInfoIsShow+"/"+PauseDivIsShow);
...
function jumpPressKeyRight()
{
	...
	if(jumpPos == 0){
		...
		jumpPos++;	
		  ...
		  clearTimeout(timeID_jumpTime); timeID_jumpTime = "";  isJumpTime = 0;
		  processSeek(currTime);
	}
}
//暂停键后的左右键
...
{	
	...
	{	
		...
		case "EVENT_MEDIA_END":setEPG();finishedPlay();return false;
		case "EVENT_MEDIA_BEGINING"://setTimeout(hideAllDiv,200);
			 speed = 1;break;
...
{
	//delayCreateMinEpg();
	setTimeout(delayCreateMinEpg,800);
}
...
{	
	...
	else
	{
		...
		$("end").focus();
		positionFlag = 5;
		tempTime=  setTimeout(antoQuit,3000);
	}
...
<div id="quitDiv" style="display:none;">
    ...
    <div style="position:absolute; left:170px; top:135px; width:340px; height:200px; z-index:2; color:#FFFFFF; font-size:20px;">
          ...
          <a id="quit" href="javascript:quit();" style="position:absolute; left: 62px; top: 95px;"><img src = "../images/dot.gif" width="45px" height="30px"/></a> 
          <a id="cancel" href="javascript:cancel();" style="position:absolute;left:228px; top:95px;"><img src = "../images/dot.gif" width="45px" height="30px"/></a>
          <a id="bookmark" href="javascript:saveBookMark();" style="position:absolute;left:98px; top:157px;"><img src = "../images/dot.gif" width="145px" height="30px"/></a> 
    </div>
</div>
<%--退出层end----------------------%> 
  
<%--连续剧播放下一集begin---------webkit适配----------%>
...
<div id="preNextDiv" style="position:absolute; left:200px; top:155px; width:340px; height:280px;display:none; z-index:2; color:#FFFFFF; font-size:22px;">
  <table height="140" width="320">
    ...
    <tr>
      <td colspan="5" style="color:#FFF;font-size:22px;">您是否继续收看下一集?</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td style="color:#FFF; font-size:20px;">下一集</td>
      <td>&nbsp;</td>
      <td style="color:#FFF; font-size:20px;">退出</td>
      <td>&nbsp;</td>
    </tr>
  </table>
...
<div id="endDiv" style="position:absolute; left:180px; top:170px; width:310px; height:262px; display:none; color:#FFFFFF; font-size:24px;">
 <table height="62" width="300" border="0">
  ...
  <div style="position:absolute; left:75px;top:100px;font-size:24px">3秒后自动退出</div>
