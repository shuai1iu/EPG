...
<body onLoad="init();" onUnload="exitPage()" background="images/lxj/lxj_bg_1.jpg">
    ...
    <a id="but_focus_0" href="#" onClick="keyPageDown()" style="left:169px; top:287px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
    <a id="but_focus_1" href="#" onClick="keyPageUp()" style="left:248px; top:287px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
    
    <a id="but_focus_2" href="#" onClick="keyBack()" style="left:327px; top:287px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
...
<div style="position:absolute; width:496px; height:125px; top:325px; left:64px;">
...
//	saveFocus();
	...
	window.location.href = "../play_controlVod.jsp?PROGID="+vodInfo.subVodIdList[index+pageSize*currPage]+"&FATHERSERIESID="+vodId+"&PLAYTYPE=1&BEGINTIME=0&PRODUCTID=0&SERVICEID=0&ONECEPRICE=0&CONTENTTYPE=10&backurl="+backurl;
}
/*function saveFocus()
{
