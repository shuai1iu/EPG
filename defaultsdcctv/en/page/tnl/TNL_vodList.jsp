...
//	System.out.println("--------------returnUrl:"+returnUrl);
	String recTypeId = null == request.getParameter("typeId") ? "-1" : request.getParameter("typeId");
	String nameFlag = null == request.getParameter("nameFlag") ? "0" : request.getParameter("nameFlag");
%>
<%@ include file="datajsp/vod_ListData.jsp"%>
<%
	String preFocus = null == request.getParameter("PREFOUCS") ? (vodList.size() == 0 ? "nav_focus_0,0,0":"focus_0,0,0"): request.getParameter("PREFOUCS");
...
<title>怀旧经典</title>
<style>
	body{ background:url(images/list/vodList_bg.png) no-repeat;}
	.nav{position:absolute;width:113px;height:50px;left:0px;top:5px;}
	.nav_focus{position:absolute; width:113px; height:56px; left:0px; top:3px;}
	.poster_focus{position:absolute;width:108px;top:383px;height:109px;}
	.list{position:absolute; width:330px; height:33px; left:0px; background:url(images/hjjd/list_bg.png);}
	.lable{position:absolute; width:60px; height:31px; left:0px; top:0px; font-size:22px; text-align:center; line-height:31px;}
	.list_focus{position:absolute; width:348px; height:43px; left:0px; display:none;}
	.name{position:absolute;width:300px;height:31px;left:10px;top:0px;font-size:20px;line-height:31px; overflow:hidden;}
	...
	.input{position:absolute; width:52px; height:31px; left:334px; text-align:center; font-size:20px; line-height:31px;}
</style>
</head>
...
<!--<a href="#" id="defaultFoucs" style="position:absolute; left:15px; top:10px;"><img src="images/dot.gif" width="1" height="1"/></a>-->
<div style="position:absolute; width:610px; height:60px; left:15px; top:45px;">
<a id="nav_focus_0" href="#" class="nav_focus" style="left:5px;" onClick="gotoHome()">
<img src="images/dot.gif" width="113" height="56"/></a></div>

<div style="position:absolute; width:600px; height:50px; left:22px; top:50px;">
<div id="typeName" class="nav" style="left:120px; top:0px;width:439px; line-height:50px; font-size:24px; color:#632d26;"></div>
</div>
...
<a id="pageDown_focus_0" href="#" onClick="keyPageDown()" style="left:22px; top:110px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
<a id="pageUp_focus_0" href="#" onClick="keyPageUp()" style="left:101px; top:110px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
<a id="back0" href="#" onClick="keyBack()" style="left:180px; top:110px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
<a id="pageDown_focus_1" href="#" onClick="keyPageDown()" style="left:22px; top:460px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
<a id="pageUp_focus_1" href="#" onClick="keyPageUp()" style="left:101px; top:460px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
<a id="back1" href="#" onClick="keyBack()" style="left:180px; top:460px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
...
<a id="input_focus0" href="#" class="input" style="top:112px;" onFocus="changeInputObj('input0')" onKeyPress="keyInput()"><img src="images/dot.gif" width="52" height="31"/></a>
<a id="input_focus1" href="#" class="input"  style="top:462px;"onFocus="changeInputObj('input1')" onKeyPress="keyInput()"><img src="images/dot.gif" width="52" height="31"/></a>

<div id="input0" style="top:111px;" class="input"></div>
<div id="input1" style="top:462px;" class="input"></div>
...
<div style="position:absolute; width:50px; height:30px; left:285px; top:463px; font-size:24px; line-height:30px;">跳至</div>
<div style="position:absolute; width:50px; height:30px; left:387px; top:463px; font-size:24px; line-height:30px;">页</div>-->
...
<a id="media_focus" href="#" onClick="playVod(currPlayVod%pageSize,true);" style="position:absolute;left:361px; top:152px;"><img src="images/dot.gif" width="260" height="218"/></a>
<!--</div>-->
<div style="position:absolute; width:350px; height:293px; left:21px; top:152px;">
  <a id="focus_0" href="#" class="list_focus" style="top:0px;" onClick="playVod(0)">
  <img src="images/dot.gif" width="345" height="40"/></a>
...
var loadFlag = 0;
var playCommonUrl = "";
var backurl = "tnl/TNL_vodList.jsp";
var nameObj = ["养生之道","舞动夕阳","食全食美"];
var typeName = nameObj[nameFlag]+" >> "+tName;

function init()
{
	initMediaPlay();
	showVodList();
	$("typeName").innerText = typeName;
	if(vodList.length > 0)initPlayVod(currPlayVod);
}
function gotoHome()
{
	window.location.href = "TNL_Category.jsp?null";
}
...
function playVod(index,flag)
{
	...
	else
	{
		...
		backurl = encodeURIComponent("tnl/TNL_vodList.jsp?typeId="+typeId+"&nameFlag="+nameFlag+"&PREFOUCS="+focusObj+","+currPage+","+currPlayVod);
