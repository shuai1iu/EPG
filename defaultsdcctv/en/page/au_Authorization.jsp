                ...
                if(4353 == mProdIdInt) 
                    {
                        ...
                        play_url+="&PLAYTYPE=1";
                        pageName = "common_order.jsp?SUBJECTID="+typesId+"&VODID="+sProgId+"&FATHERID="+sProgId+"&PLAYTYPE=1&CONTENTTYPE="+sContentType+"&BUSINESSTYPE=1";
                        session.setAttribute("playurl",play_url + "&backurl=" + goback);
                        String playUrl = (String)session.getAttribute("playurl");
                        %>
                        <script>
                            var pageName =  "<%=pageName%>";
