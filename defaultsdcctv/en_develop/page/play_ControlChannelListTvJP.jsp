...
// result = metaData.getChanListByTypeId(gaoqingzhibocode,-1,0);
 ...
 recChanList=(ArrayList)result1.get(1);
// channel1=(ArrayList)result1.get(1);
// recChanList.addAll(channel1);
}
else{
  result = metaData.getChanListByTypeId("10000100000000090000000000039770",-1,0);//精品频道
...
if(parseInt(currIndex)==-1){
	parent.currChannelNum=parent.channelNums[0];
	currIndex=0;
}
