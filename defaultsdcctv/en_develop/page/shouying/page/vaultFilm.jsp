...
function bindFilmsData(datavalue)
{
	...
	for(i=0;i<area2.doms.length;i++)
	{
	   if(i<datavalue.length)
	   {
		   area2.doms[i].setcontent("",datavalue[i].VODNAME,22,true,true);
...
<div class="wrapper">
	...
	<div class="list-b">
		...
		<div class="item" id="area2_list_1" style="left:295px;">
			<div class="txt" id="area2_text_1"></div>
		</div>
		<div class="item" id="area2_list_2" style="top:41px;">
			<div class="txt"  id="area2_text_2"></div>
		</div>
		<div class="item" id="area2_list_3" style="left:295px;top:41px;">
			<div class="txt" id="area2_text_3"></div>
		</div>
		<div class="item" id="area2_list_4" style="top:82px;">
			<div class="txt" id="area2_text_4"></div>
		</div>
		<div class="item" id="area2_list_5" style="left:295px;top:82px;">
			<div class="txt" id="area2_text_5"></div>
		</div>
		<div class="item" id="area2_list_6" style="top:123px;">
			<div class="txt" id="area2_text_6"></div>
		</div>
		<div class="item" id="area2_list_7" style="left:295px;top:123px;">
			<div class="txt" id="area2_text_7"></div>
		</div>
		<div class="item" id="area2_list_8" style="top:164px;">
			<div class="txt" id="area2_text_8"></div>
		</div>
		<div class="item" id="area2_list_9" style="left:295px;top:164px;">
			<div class="txt" id="area2_text_9"></div>
		</div>
		<div class="item" id="area2_list_10" style="top:205px;">
			<div class="txt" id="area2_text_10"></div>
		</div>
		<div class="item" id="area2_list_11" style="left:295px;top:205px;">
			<div class="txt" id="area2_text_11"></div>
		</div>
		<div class="item" id="area2_list_12" style="top:246px;">
			<div class="txt" id="area2_text_12"></div>
		</div>
		<div class="item" id="area2_list_13" style="left:295px;top:246px;">
			<div class="txt" id="area2_text_13"></div>
		</div>
		<div class="item" id="area2_list_14" style="top:287px;">
			<div class="txt" id="area2_text_14"></div>
		</div>
		<div class="item" id="area2_list_15" style="left:295px;top:287px;">
