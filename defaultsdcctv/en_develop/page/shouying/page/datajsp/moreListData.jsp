...
String renQiORTuijianFlag = request.getParameter("renQiORTuijianFlag")==null?"renQi":request.getParameter("renQiORTuijianFlag");
int contentTotal=0;
String typeId ="";
if(renQiORTuijianFlag.equals("renQi"))
{
	typeId=shouyerenqiduo;
}
else
{
	typeId=shouyetuijianduo;
}
MetaData metadata = new MetaData(request);
ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(typeId,pagesize,stratPosition);
...
moreDataList=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(moreDataList);
}
</script>