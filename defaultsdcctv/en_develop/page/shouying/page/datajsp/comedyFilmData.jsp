...
ArrayList vodlist = (ArrayList)metadata.getVodListByTypeId(xiju,pagesize,stratPosition);
...
comedyFilmData=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(comedyFilmData);
}
</script>