...
window.onload = function()
{
	 ...
	 area3=AreaCreator(1,2,new Array(-1,-1,0,-1),"area7_list_","className:item item_focus","className:item ");
	...
	area0 = AreaCreator(1,4,new Array(3,-1,1,-1),"area0_list_","className:item item_focus","className:item");
	...
	pageobj = new PageObj(areaid!=null?parseInt(areaid):0,indexid!=null?parseInt(indexid):0, new Array(area0,area1,area2,area3),null);
