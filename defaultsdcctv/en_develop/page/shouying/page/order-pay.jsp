...
<title>单片订购支付页面-深圳标清首映EPG2.0</title>
...
<div class="wrapper">
	...
	<div class="order-form form01">
		...
		<div class="txt txt02" style="top:56px; left:155px;"><span><%=price%></span>&nbsp;元</div>
		
		<div class="txt txt01" style="top:111px;">有效期</div>
		<div class="txt txt02" style="top:111px;"><%=ppvsj1%></div>
		<div class="txt txt03" style="top:111px; "><%=ppvsj2%></div>
