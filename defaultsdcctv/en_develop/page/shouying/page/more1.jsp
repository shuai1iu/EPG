...
window.onload = function()
{
	...
	area1.asyngetdata=function()
	{
		...
		$('hidden_frame').src = "<%=basePath%>datajsp/moreListData.jsp?isFirstFlag=1&stratPosition="+(this.curpage-1)*8;
		//getAJAXData("datajsp/moreListData.jsp?stratPosition="+(this.curpage-1)*8+"&isFirstFlag=1",bindFilmsData);
		
	}
	
	area0 = AreaCreator(1,4,new Array(4,-1,1,-1),"area0_list_","className:item item_focus","className:item");
	area0.areaOkEvent = function()
	{
		...
		else if(area0.curindex==3)
		{
			   ...
			   &&area0_numString>0&&area0_numString<=area1.pagecount)
			{
			    ...
			    $('hidden_frame').src = "<%=basePath%>datajsp/moreListData.jsp?isFirstFlag=1&stratPosition="+(area1.curpage-1)*8;
			}
			else
			{
				area0_numString="";
	...
	pageobj = new PageObj(areaid!=null?parseInt(areaid):0,indexid!=null?parseInt(indexid):0, new Array(area0,area1,area2,area4),null);
...
<div class="wrapper">
	...
	<div class="pages">
		...
		<div class="btn">
			...
			<div class="item" id="area0_list_1" style="left:60px;">上页</div>
            <div class="item item_not" id="areaGray0_list_1" style="left:60px;display:none">上页</div>
			<div class="item" id="area0_list_2" style="left:120px;">返回</div>
		</div>
		<div class="input">
			<div class="txt">跳转至</div>
			<div class="item" id="area0_list_3" style="left:64px;"></div>
	...
	<div class="pages" style="top:478px;">
		...
		<div class="btn">
			...
			<div class="item" id="area2_list_1" style="left:60px;">上页</div>
            <div class="item item_not" id="areaGray2_list_1" style="left:60px;display:none">上页</div>
			<div class="item" id="area2_list_2" style="left:120px;">返回</div>
		</div>
		<div class="input">
			<div class="txt">跳转至</div>
			<div class="item" id="area2_list_3" style="left:64px;"></div>
...
<iframe name="hidden_frame" id="hidden_frame" style=" display:none" width="0" 
</body>
</html>
