...
<title>特惠包月3-深圳标清首映EPG2.0</title>
...
<div class="wrapper">
	...
	<div class="btn-c" style="left:185px;">
		...
		-->
		<div class="item item_focus" id="area0_list_0">立即订购</div>
        <div class="item" id="area0_list_1"style="left:145px;">返&nbsp;回</div>
	</div>
	<!--order the end-->
