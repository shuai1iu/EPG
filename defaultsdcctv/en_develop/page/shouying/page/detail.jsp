...
{		
	...
	if(isSticom==0)
	{
		...
		area0.areaOkEvent = function()
	    {
			if(area0.curindex==0&&isPlay=="1")
			{
				 /* progId = mediadetailInfo.VODID;
				  ...
				  play_url+="&PLAYTYPE=1";
				  play_url+="&backurl="+escape("<%=basePath%>detail.jsp?areaid=0&indexid=0&cateNamePosition="+cateNamePosition+"&isPlay="+isPlay+"&vodid="+fatherSeriesId+"&returnurl="+returnurl);
			...
			else if(area0.curindex==1&&isBookMark==true)
			{
				 /* progId = mediadetailInfo.VODID;
				  ...
				  play_url+="&backurl="+escape("<%=basePath%>detail.jsp?areaid=0&indexid=1&cateNamePosition="+cateNamePosition+"&isPlay="+isPlay+"&vodid="+fatherSeriesId+"&returnurl="+returnurl);
				  window.location.href=play_url;*/
		...
		{
			indexid = 0;
		   $("item_not_show_preview").className="btn btn_not_preview";
		}
		else
		{
		   $("item_not_show_preview").className="btn btn-preview";
		}
		
		if(isBookMark==false||isBookMark==undefined)
		{
		   $("item_not_show_bookMark").className="btn btn_not_see";
		    indexid = 0;
		}
		else
		{
		   $("item_not_show_bookMark").className="btn btn-see";
		   indexid = 1;
		}
	 ...
	 //	pageobj = new PageObj(2,0,new Array(area0,area2),null);
	}
	else
	{
...
function checkBookmark(subVoddetailInfo){
	...
	else
	{
		...
		play_url+="&BUSINESSTYPE=1";
		play_url+="&PLAYTYPE=1";
		play_url+="&backurl="+escape("<%=basePath%>detail.jsp?areaid=0&indexid="+area0.curindex+"&cruntpage="+area0.curpage+"&cateNamePosition="+cateNamePosition+"&isPlay="+isPlay+"&vodid="+fatherSeriesId+"&returnurl="+returnurl);
	    window.location.href=play_url;*/
...
<div class="wrapper">
	...
	<div class="detail">
		...
		<div class="txt txt01" style="top:45px;">导&nbsp;&nbsp;演：</div>
		<div class="txt txt01" style="top:75px;">主&nbsp;&nbsp;演 ：</div>
		<div class="txt txt01" style="top:105px;">简&nbsp;&nbsp;介：</div>
		
		<div class="txt txt02" style="top:45px; font-size:20px;" id="vodDirector"></div>
		<div class="txt txt02" style="top:75px; font-size:20px;" id="vodActor"></div>
		<div class="txt txt02" style="top:105px;" id="vodIntroduce"></div>
	</div>
     ...
     <div class="btn-a" id="vodDetailDiv" style="display:none;">
		...
		<div class="item" id="areaDetail0_list_1" style="left:88px;">
			<div class="link"></div>
			<div class="btn btn-see" id="item_not_show_bookMark"><!--续看--></div>
		</div>
		<div class="item" id="areaDetail0_list_2" style="left:176px;">
			<div class="link"></div>
			<div class="btn btn-preview" id="item_not_show_preview"><!--预览--></div>
		</div>
		<div class="item" id="areaDetail0_list_3" style="left:264px;">
			<div class="link"></div>
...
<!--pages-->
	<div class="pages" id="subListOptionDiv" style="top:345px; left:275px; display:none">
		<!--焦点 
				class="item item_focus"
			灰色/不可用
				class="item item_not"
		...
		<div class="btn">
			...
			<div class="item" style="left:60px;" id="areaTvDetail1_list_1">上页</div>
			<div class="item" style="left:120px;" id="areaTvDetail1_list_2">返回</div>
		</div>
		<div class="input">
...
<!--play-num-->
	<div class="play-num" id="subListNumDiv" style="display:none">
		<!--焦点 
				class="item item_focus"
		-->	
		<div class="item" style="left:8px;" id="areaTvDetail0_list_0"></div>
		<div class="item" style="left:48px;" id="areaTvDetail0_list_1"></div>
		<div class="item" style="left:88px;" id="areaTvDetail0_list_2"></div>
		<div class="item" style="left:128px;" id="areaTvDetail0_list_3"></div>
		<div class="item" style="left:168px;" id="areaTvDetail0_list_4"></div>
		<div class="item" style="left:208px;" id="areaTvDetail0_list_5"></div>
		<div class="item" style="left:248px;" id="areaTvDetail0_list_6"></div>
		<div class="item" style="left:288px;" id="areaTvDetail0_list_7"></div>
		
		<div class="item" style="left:8px; top:40px;" id="areaTvDetail0_list_8"></div>
		<div class="item" style="left:48px;top:40px;" id="areaTvDetail0_list_9"></div>
		<div class="item" style="left:88px;top:40px;" id="areaTvDetail0_list_10"></div>
		<div class="item" style="left:128px;top:40px;" id="areaTvDetail0_list_11"></div>
		<div class="item" style="left:168px;top:40px;" id="areaTvDetail0_list_12"></div>
		<div class="item" style="left:208px;top:40px;" id="areaTvDetail0_list_13"></div>
		<div class="item" style="left:248px;top:40px;" id="areaTvDetail0_list_14"></div>
		<div class="item" style="left:288px;top:40px;" id="areaTvDetail0_list_15"></div>
  	</div>	
	<!--play-num the end-->
