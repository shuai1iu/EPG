...
<%
	...
	*/
	...
	if(tag==null||tag==1||tag==2)
	{
		...
		try{
			tmpAdVas=(ArrayList)new MetaData(request).getVasListByTypeId("10000100000000090000000000038450",6,0);
		} catch(Exception e){
			...
			if(apppic!=null&&apppic!=""&&apppic!=undefined)
					{
						...
						if(tag==1)
						{
							...
							document.getElementById("test").innerHTML="tag:"+tag;
						}
						else if(tag==2)
						{
							alert(1);
...
// 广告加载完成
	   ...
	   area0.doms[4].mylink="test_index.jsp"//"app.jsp";
...
<div id="ad">
	<img id="frame_content"  src="../<%=apppic%>" style="width:100%;height:100%;z-index:50;"/>
</div>
<div id="index" style="visibility:hidden;z-index:1;">

    <!-- E LOGO -->
	<div id="test">this is my test div</div>
