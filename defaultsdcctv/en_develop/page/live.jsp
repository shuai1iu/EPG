...
<%
   ...
   window.onload=function()
   {
	   ...
	   {
			var channelId = area1.doms[area1.curindex].channelnum;
			var channelID1=area1.doms[area1.curindex].dataurlorparam;
			if(channelId!="undefined" && channelId!= undefined ){ 
				if(containFun(markArray,channelId)){
					//alert(channelId + " 过滤频道 " + markArray);
					window.location.href="play_ControlChannel2.jsp?ControlFlag=1&CHANNELID="+channelID1+"&CHANNELNUM="+channelId+"&COMEFROMFLAG=1&returnurl="+escape(location.href);
				 }else{
				 	//alert(channelId + " 正常频道 " + markArray);
					window.location.href="play_ControlChannel2.jsp?ControlFlag=0&CHANNELID="+channelID1+"&CHANNELNUM="+channelId+"&COMEFROMFLAG=1&returnurl="+escape(location.href); 
				 }
			 }
		}
