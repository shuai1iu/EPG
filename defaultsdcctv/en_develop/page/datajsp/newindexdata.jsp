...
ArrayList array=new MyUtil(request).getVasListData(shouyetuijiancoe,14);
ArrayList array1=new MyUtil(request).getVasListData(shouyerediancode,6);
ArrayList array2=new MyUtil(request).getVasListData(shouyezhuanticode,2);
ArrayList array3=new MyUtil(request).getVodListData(shouyetuijiancode,2);
ArrayList array3_vas=new MyUtil(request).getVasListData(shouyezhuanticode1,1);
...
ArrayList tmpvas=(ArrayList)metadata.getVasListByTypeId(shouyezhuanticode, 2, 0);
