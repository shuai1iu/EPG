...
function bindContentData(itm) {
	if((area0 !=undefined) &&(area0.doms[0] !=undefined) ) //ztewebkit
	...
	$("vodSubcount").innertHTML = '<span class="th">片长：</span>'+(itm.ELAPSETIME==undefined?0:itm.ELAPSETIME)+'分钟'
	...
	$("vodDrt").innerHTML = '<span class="th">主持：</span>'+itm.DIRECTOR;
	itm.ACTOR = (itm.ACTOR==undefined||itm.ACTOR=="null")?"暂无":itm.ACTOR;
	itm.ACTOR = (getbytelength(itm.ACTOR)>13)?getcutedstring(itm.ACTOR,13):itm.ACTOR;
	$("vodAct").innerHTML = '<span class="th">嘉宾：</span>'+itm.ACTOR;
