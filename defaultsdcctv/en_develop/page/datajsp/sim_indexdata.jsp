...
try{
	array = new MyUtil(request).getVasListData("10000100000000090000000000032090",14);//推荐
}catch(Exception e){
}
...
try{
	array2 = new MyUtil(request).getVasListData("10000100000000090000000000029041",2);//专题 右侧2张图
}catch(Exception e){
}

try{
	array3 = new MyUtil(request).getVodListData("10000100000000090000000000029550",2);
}catch(Exception e){
}

try{
	array3_vas = new MyUtil(request).getVasListData("10000100000000090000000000032091",1);//电影 下侧3张图
}catch(Exception e){
}
...
try{
	tmpvas=(ArrayList)metadata.getVasListByTypeId("10000100000000090000000000029041", 2, 0);
}catch(Exception e){
}
/***************20130910 15:00 ZSZ 新增异常处理*****************/
...
try{
	tmpimgVas=(ArrayList)metadata.getVasListByTypeId("10000100000000090000000000032091", 1, 0);
}catch(Exception e){
}
/***************20130910 15:00 ZSZ 新增异常处理*****************/
...
System.out.println("ARRAY2==="+array2Tmp);
}catch(Exception e){
	array2Tmp = "null";
}
...
System.out.println("Vas3Tmp==========="+array3_vasTmp);
}catch(Exception e){
	array3_vasTmp = "null";
}
