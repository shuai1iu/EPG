...
try{
	array2_sec = new MyUtil(request).getVasListData("10000100000000090000000000037210",2);//专题 右侧2张图 第二组切换
}catch(Exception e){
}
...
try{
        array3_vas_sec = new MyUtil(request).getVasListData("10000100000000090000000000037492",1);//右下角VAS位 第二组切换
}catch(Exception e){
}
System.out.println("ARRAY#_SEC====="+array3_vas_sec);
...
try{
	tmpimgVas_sec=(ArrayList)metadata.getVasListByTypeId("10000100000000090000000000037492", 1, 0);
}catch(Exception e){
}
/***************20130910 15:00 ZSZ 新增异常处理*****************/
...
System.out.println("ARRAY#TMPSEC=============="+array3_vasTmp_sec);
