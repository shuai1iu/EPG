...
var rtspChan = unescape(<%=rtspChan%>);

if(rtspChan == null)
{
    rtspChan = "rtsp://125.88.104.45/PLTV/88888895/224/3221227202/10000100000000060000000000966366_0.smil";
}
...
function initMediaPlay()
{
	...
	mp.setVideoDisplayArea(0,0,640,530);
