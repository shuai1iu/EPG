...
if("1" == isFirst)
{
document.getElementById("log_frame").src = "http://219.133.42.99:8080/EPG_Statistics/EPG_BOOT.jsp?userID="+user+"&EPG_TYPE=SD&STB_TYPE="+ STBType + "&GROUP=" + <%=groupId%>;
}
...
//	area0.doms[0].mylink=indexhref[0] + "?returnurl=" + returnurl;
//	area0.doms[1].mylink=indexhref[1] + "?returnurl=" + returnurl;
//	area0.doms[2].mylink=indexhref[2] + "?returnurl=" + returnurl;
//	area0.doms[3].mylink=indexhref[3] + "?returnurl=" + returnurl;
//	area0.doms[4].mylink=indexhref[4] + "?returnurl=" + returnurl;
//	area0.doms[5].mylink=indexhref[5] + "?returnurl=" + returnurl;
//	area0.doms[6].mylink=indexhref[6] + "?returnurl=" + returnurl;	   
...
/*在搜索点击确认键时触发入口探针*/
	...
	{
            //2014-02-07广告保护修改
	    area5Url="play_ControlChannel2.jsp?ControlFlag=0&CHANNELNUM=<%=shouyezhibo%>&COMEFROMFLAG=1&returnurl="+escape(location.href);
            /*现网版本临时注释掉*/
...
function VASimg1(data,area)
{
	...
	{   
		...
		{
			//area.doms[0].mylink = "../../../"+data[0].VASURL+"?back=1&returnurl="+returnurl;
