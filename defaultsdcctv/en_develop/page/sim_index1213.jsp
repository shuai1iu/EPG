...
<script type="text/javascript">
   ...
   {   
	   ...
	   area0.doms[5].mylink="test_index.jsp"//"app.jsp";"topiclist.jsp?returnurl="+returnurl;
...
/*
			...
			{
			/*
				if(url.match("defaultsdcctv/en/page/")||url.match("defaultgdsd/en/page/"))
				{
			...
			*/
				window.location.href="../../../"+data[i].VASURL+"&?back=0&returnurl="+returnurl;
				alert(i+"||"+data[i].VASURL+"&?back=0&returnurl="+returnurl);	
*/
		}
		}
		else{
