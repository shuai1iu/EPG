...
int currChanIndex = 0;                                  //当前频道索引 初始值为-1
...
int tmpchannelNum=Integer.parseInt(channelNum);//为找到焦点而修改，因为下发的减了1000，但是平台接口没有  Integer.parseInt(channelNum)+1000
while(iter.hasNext())
{
...
<script>
	...
	parent.channelNums[<%=i%>] = tempChannelNum; //tempChannelNum-1000;
	tempChannelNum=tempChannelNum;//tempChannelNum-1000
...
//当前是第几页
parent.currListPage =Math.floor(currIndex / 8);
parent.init_page();
