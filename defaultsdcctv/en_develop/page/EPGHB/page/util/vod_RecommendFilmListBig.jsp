...
<%
     int vodSize = 0;
	 List recommendvod= metaData.getVodListByTypeId(VOD_LIST_TYPEID,5,0);
...
/*			     String picPathArray = getPosterPathArray(picpathTemp,request);
				 String[] tempArray = new String[]{};
				 String picPath="";
	             tempArray =picPathArray.split(",");
