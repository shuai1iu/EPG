...
<%
	...
	String preFocus = null == request.getParameter("PREFOUCS") ? (vodList.size() == 0 ? "nav_focus_3,0,0":"focus_0,0,0"): request.getParameter("PREFOUCS");
...
<style>
	body{ background:url(images/syhm/syhm_bg.png) no-repeat;}
...
<a href="#" onClick="keyBack()" style="left:180px; top:110px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
...
<a href="#" onClick="keyBack()" style="left:180px; top:460px;" class="button"><img src="images/dot.gif" width="83" height="36"/></a>
...
function playVod(index,flag)
{
	...
	else
	{
		...
		backurl = "tnl/TNL_syhm.jsp?PREFOUCS="+focusObj+","+currPage+","+currPlayVod;
...
function keyBack()
{
	window.location.href = "TNL_Category.jsp?PREFOUCS=nav_focus_3";
}
function exitPage()
{
	mp.stop();
