...
<title>怀旧经典</title>
<style>
	body{ background:url(images/hjjd/hjjd_bg.png) no-repeat;}
...
<div id="pageNum0" class="pagenum" style="top:112px;"></div>
<div id="pageNum1" class="pagenum" style="top:462px;"></div>
