...
<%
	...
	String returnUrl = null == request.getParameter("returnurl") ? "../index.jsp" : request.getParameter("returnurl");//getReturnUrl(turnPage);
	turnPage.addUrl();
...
<img id="poster_0" src="" width="364" height="210" style="position:absolute; width:362px; height:210px; left:40px; top:118px;"/>
<img id="poster_1" src="" width="179" height="103" style="position:absolute; width:179px; height:103px; left:423px; top:116px;"/>
<img id="poster_2" src="" width="179" height="103" style="position:absolute; width:179px; height:103px; left:423px; top:225px;"/>
    
<a id="poster_focus_0" href="#" onClick="playVod(0);" style="position:absolute; width:376px; height:226px; left:32px; top:110px;">
	<img src="images/dot.gif" width="376" height="226"/></a>
<a id="poster_focus_1" href="#" onClick="playVod(1);" style="position:absolute; width:189px; height:113px; left:418px; top:111px;">
	<img src="images/dot.gif" width="189" height="113"/></a>
<a id="poster_focus_2" href="#" onClick="playVod(2);" style="position:absolute; width:189px; height:113px; left:418px; top:220px;">
	<img src="images/dot.gif" width="189" height="113"/></a>
