...
<%  
    ...
    ArrayList recChanchannel=new ArrayList();
	
 
    recChanresult = recmetaData.getChanListByTypeId(biaoqingzhibocode,-1,0);//标清直播CODE
    recChanchannel=(ArrayList)recChanresult.get(1);
    recChanList.addAll(recChanchannel);//得到所有的
    int realSize = 0;
...
<div id="topframe" style="position:absolute;font-size:50px;left:160px;top:118px;width:300px;height:30px;z-index:11;color:#FFF;text-align:right;">
