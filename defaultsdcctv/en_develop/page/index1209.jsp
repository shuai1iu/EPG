...
<div id="ad" style="display:inline;z-index:1">
	<img id="frame_content"  src="../<%=apppic%>" style="width:100%;height:100%" onload="iFrameHeight()"/>
</div>
<div id="index" style="display:none;z-index:20">
