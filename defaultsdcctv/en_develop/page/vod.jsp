...
<div class="wrapper">
    ...
    <div class="mod-vodContlist" id="second_pro">
        	
        <div class="item" style="left:215px; top:144px;">
            <div class="link" id="area1_list_0"  style="width:200px;height:200px"><img src="" id="area1_pic" style="width:100%;height:100%"></div>
