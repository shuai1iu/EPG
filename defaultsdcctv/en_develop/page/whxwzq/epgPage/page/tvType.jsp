...
<title>电视剧类型-湖北广电标清EPG2.0</title>
...
<script>
	...
	<jsp:include page="<%=categoryListFile%>">
		<jsp:param name="parentCategoryCode" value="<%=categoryCode_dsj_lx%>" /> 
	...
	var area3={curindex:0,datanum:<%=vodListNum%>,name:"area3",areaid:3,curpage:<%=tempcurVodListPage%>,pagenum:<%=temptotalVodListPage%>,rows:2,cols:3};
	var area4={selectIndex:<%=area4SelectIndex%>,selectPage:1,curindex:0,datanum:<%=categoryListNum%>,name:"area4",areaid:4,curpage:1,pagenum:1,rows:10,cols:1};
	...
	*/
	...
	area4.ok = function(){
		...
		curVodListCode = categoryListData.categoryList[area4.curindex].categoryCode;
	...
	area3.pageTurnEvent = function(num){
		...
		if(area3.pagenum>1){
			if(tmp>=1&&tmp<=area3.pagenum){
				...
				area3.curpage = tmp;
				$("hidden_frame").src = "<%=tempProperBath%>iframe/getVodListFrame.jsp?categoryCode="+curVodListCode+"&curpage="+area3.curpage;
			}else if(tmp<1){
				area3CurindexSetZero();
...
<!-- menu -->
	<div class="menu-tv">
		...
		<div class="item item_select" style="left:480px;">
...
<!-- 热门分类 -->
	<div class="pic" style="left:34px; top:127px;"><img src="../images/font-hot.png" alt="热门分类" /></div>
	<div class="nav-tv">
		<div class="item">
			<div class="link"><a id="area4_a_0" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:35px;">
			<div class="link"><a id="area4_a_1" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:70px;">
			<div class="link"><a id="area4_a_2" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:105px;">
			<div class="link"><a id="area4_a_3" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:140px;">
			<div class="link"><a id="area4_a_4" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:175px;">
			<div class="link"><a id="area4_a_5" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
		...
		<div class="item" style="top:210px;">
			<div class="link"><a id="area4_a_6" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
			<div id="area4_txt_6" class="txt">
				<% if(tempcategoryList.size()>6) {
                   if(getbytelength(tempcategoryList.getJSONObject(6).get("name").toString())>=area4NameLength){
                      %>
                       <%=getcutedstring(tempcategoryList.getJSONObject(6).get("name").toString(),area4NameLength,false)%>
                <%}else{%>
		...
		<div class="item" style="top:245px;">
			<div class="link"><a id="area4_a_7" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
			<div id="area4_txt_7" class="txt">
				<% if(tempcategoryList.size()>7) {
                   if(getbytelength(tempcategoryList.getJSONObject(7).get("name").toString())>=area4NameLength){
                      %>
                       <%=getcutedstring(tempcategoryList.getJSONObject(7).get("name").toString(),area4NameLength,false)%>
                <%}else{%>
		...
		<div class="item" style="top:280px;">
			<div class="link"><a id="area4_a_8" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
			<div id="area4_txt_8" class="txt">
				<% if(tempcategoryList.size()>8) {
                   if(getbytelength(tempcategoryList.getJSONObject(8).get("name").toString())>=area4NameLength){
                      %>
                       <%=getcutedstring(tempcategoryList.getJSONObject(8).get("name").toString(),area4NameLength,false)%>
                <%}else{%>
                     <%=tempcategoryList.getJSONObject(8).get("name").toString()%>
                <%}
               }%>
            </div>
        </div>
		<div class="item" style="top:315px;">
			<div class="link"><a id="area4_a_9" href="#"><img src="../images/t.gif" width="155" height="35" /></a></div>
			<div id="area4_txt_9" class="txt">
				<% if(tempcategoryList.size()>9) {
                   if(getbytelength(tempcategoryList.getJSONObject(9).get("name").toString())>=area4NameLength){
                      %>
                       <%=getcutedstring(tempcategoryList.getJSONObject(9).get("name").toString(),area4NameLength,false)%>
                <%}else{%>
                     <%=tempcategoryList.getJSONObject(9).get("name").toString()%>
                <%}
               }%>
            </div>
        </div>
