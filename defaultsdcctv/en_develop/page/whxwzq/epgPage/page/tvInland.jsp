...
<title>电视剧内地-湖北广电标清EPG2.0</title>
...
.tv-rank .item {
	background:url(../images/tv-rank02.png) no-repeat;
	height:56px;
	width:155px;
}
.tv-rank .item .txt-num {
...
.tv-rank .item-a {
	background:url(../images/tv-rank01.png) no-repeat;
	height:66px;
}
.tv-rank .item-a .pic {
...
<jsp:include page="<%=vodListFile%>">
	...
	var area4={curindex:0,datanum:<%=topicVodListNum%>,name:"area4",areaid:4,rows:6,cols:1};
...
<!-- menu -->
	<div class="menu-tv">
		...
		-->
		<div id="area1_list_0" class="<%if(area1SelectIndex==0){%>item item_select<%}else{%>item<%}%>">
			<div class="link"><a id="area1_a_0" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">首页</div>
        </div>
		<div id="area1_list_1" class="<%if(area1SelectIndex==1){%>item item_select<%}else{%>item<%}%>" style="left:80px;">
			<div class="link"><a id="area1_a_1" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">追剧</div>
        </div>
		<div id="area1_list_2" class="<%if(area1SelectIndex==2){%>item item_select<%}else{%>item<%}%>" style="left:160px;">
			<div class="link"><a id="area1_a_2" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">内地</div>
        </div>
		<div id="area1_list_3" class="<%if(area1SelectIndex==3){%>item item_select<%}else{%>item<%}%>" style="left:240px;">
			<div class="link"><a id="area1_a_3" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">港台</div>
        </div>
		<div id="area1_list_4" class="<%if(area1SelectIndex==4){%>item item_select<%}else{%>item<%}%>" style="left:320px;">
			<div class="link"><a id="area1_a_4" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">日韩</div>
        </div>
		<div id="area1_list_5" class="<%if(area1SelectIndex==5){%>item item_select<%}else{%>item<%}%>" style="left:400px;">
			<div class="link"><a id="area1_a_5" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">欧美</div>
        </div>
		<div id="area1_list_6" class="<%if(area1SelectIndex==6){%>item item_select<%}else{%>item<%}%>" style="left:480px;">
			<div class="link"><a id="area1_a_6" href="#"><img src="../images/t.gif" width="55" height="38" /></a></div>
			<div class="txt">类型</div>
        </div>
		<div id="area1_list_7" class="<%if(area1SelectIndex==7){%>item item_select<%}else{%>item<%}%>" style="left:560px;">
...
<!-- 热门排行 -->
	<div class="pic" style="left:34px; top:127px;"><img src="../images/font-ranking.png" alt="热门排行" /></div>
	<div class="tv-rank">
		<div id="area4_list_0" class="item item-a" style="<%if(tempTopicVodList.size()>0){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_0" href="#"><img src="../images/t.gif" width="155" height="66" /></a></div>
			<div class="txt txt-num">1</div>
			<div class="pic"><img id="area4_img_0" src="${topicVodListData.vodDataList[0].pictureList.poster}" /></div>
			<div id="area4_txt_0" class="txt txt-n">
		...
		<div id="area4_list_1" class="item" style="top:66px;<%if(tempTopicVodList.size()>1){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_1" href="#"><img src="../images/t.gif" width="155" height="56" /></a></div>
			<div class="txt txt-num">2</div>
			<div id="area4_txt_1" class="txt txt-n">
            	     <% if(tempTopicVodList.size()>1) {
						if(getbytelength(tempTopicVodList.getJSONObject(1).get("name").toString())>=area4NameLength){%>
							<%=getcutedstring(tempTopicVodList.getJSONObject(1).get("name").toString(),area4NameLength,false)%>
					<%}else{%>
						<%=tempTopicVodList.getJSONObject(1).get("name").toString()%>
					<%}
				   }%>
            </div>
		</div>
		<div id="area4_list_2" class="item" style="top:122px;<%if(tempTopicVodList.size()>2){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_2" href="#"><img src="../images/t.gif" width="155" height="56" /></a></div>
			<div class="txt txt-num">3</div>
			<div id="area4_txt_2" class="txt txt-n">
                    <% if(tempTopicVodList.size()>2) {
						if(getbytelength(tempTopicVodList.getJSONObject(2).get("name").toString())>=area4NameLength){%>
							<%=getcutedstring(tempTopicVodList.getJSONObject(2).get("name").toString(),area4NameLength,false)%>
					<%}else{%>
						<%=tempTopicVodList.getJSONObject(2).get("name").toString()%>
					<%}
				   }%>
            </div>
		</div>
		<div id="area4_list_3" class="item" style="top:178px;<%if(tempTopicVodList.size()>3){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_3" href="#"><img src="../images/t.gif" width="155" height="56" /></a></div>
			<div class="txt txt-num">4</div>
			<div id="area4_txt_3" class="txt txt-n">
            	    <% if(tempTopicVodList.size()>3) {
						if(getbytelength(tempTopicVodList.getJSONObject(3).get("name").toString())>=area4NameLength){%>
							<%=getcutedstring(tempTopicVodList.getJSONObject(3).get("name").toString(),area4NameLength,false)%>
					<%}else{%>
						<%=tempTopicVodList.getJSONObject(3).get("name").toString()%>
					<%}
				   }%>
            </div>
		</div>
		<div id="area4_list_4" class="item" style="top:234px;<%if(tempTopicVodList.size()>4){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_4" href="#"><img src="../images/t.gif" width="155" height="56" /></a></div>
			<div class="txt txt-num">5</div>
			<div id="area4_txt_4" class="txt txt-n">
                    <% if(tempTopicVodList.size()>4) {
						if(getbytelength(tempTopicVodList.getJSONObject(4).get("name").toString())>=area4NameLength){%>
							<%=getcutedstring(tempTopicVodList.getJSONObject(4).get("name").toString(),area4NameLength,false)%>
					<%}else{%>
		...
		<div id="area4_list_5" class="item" style="top:290px;<%if(tempTopicVodList.size()>5){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			<div class="link"><a id="area4_a_5" href="#"><img src="../images/t.gif" width="155" height="56" /></a></div>
			<div class="txt txt-num">6</div>
			<div id="area4_txt_5" class="txt txt-n">
                    <% if(tempTopicVodList.size()>5) {
						if(getbytelength(tempTopicVodList.getJSONObject(5).get("name").toString())>=area4NameLength){%>
							<%=getcutedstring(tempTopicVodList.getJSONObject(5).get("name").toString(),area4NameLength,false)%>
					<%}else{%>
						<%=tempTopicVodList.getJSONObject(5).get("name").toString()%>
					<%}
				   }%>
            </div>
		</div>
...
<!-- list -->	
	<div class="list-tv">
		<div id="area3_list_0" class="item" style="<%if(tempvodList.size()>0){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
