...
<title>电视剧追剧-湖北广电标清EPG2.0</title>
...
<jsp:include page="<%=vodListFile%>">
	<jsp:param name="categoryCode" value="<%=categoryCode_dsj_zj_topic%>" /> 
...
<jsp:include page="<%=vodListFile%>">
	<jsp:param name="categoryCode" value="<%=categoryCode_dsj_zj%>" /> 
	...
	area3.pageTurnEvent = function(num){
		...
		if(area3.pagenum>=2){
			if(tmp>=1&&tmp<=area3.pagenum){
				...
				area3.curpage = tmp;
				$("hidden_frame").src = "<%=tempProperBath%>iframe/getVodListFrame.jsp?categoryCode="+"<%=categoryCode_dsj_zj%>"+"&curpage="+area3.curpage;
			}else if(tmp<1){
				area3CurindexSetZero();
...
<!-- menu -->
	<div class="menu-tv">
		...
		<div class="item item_select" style="left:80px;">
...
<!-- 推荐 -->
	...
	<div class="tv-info">
		<div class="item">
			<div class="link"><a id="area4_a_1" href="#"><img src="../images/t.gif" width="126" height="30" /></a></div>
		...
		<div class="item" style="top:30px;">
			<div class="link"><a id="area4_a_2" href="#"><img src="../images/t.gif" width="126" height="30" /></a></div>
		...
		<div class="item" style="top:60px;">
			<div class="link"><a id="area4_a_3" href="#"><img src="../images/t.gif" width="126" height="30" /></a></div>
			<div id="area4_txt_3" class="txt">
		...
		<div class="item" style="top:90px;">
			<div class="link"><a id="area4_a_4" href="#"><img src="../images/t.gif" width="126" height="30" /></a></div>
			<div id="area4_txt_4" class="txt">
		...
		<div class="item" style="top:120px;">
			<div class="link"><a id="area4_a_5" href="#"><img src="../images/t.gif" width="126" height="30" /></a></div>
			<div id="area4_txt_5" class="txt">
...
<!-- list -->	
	<div class="list-tv">
		<div id="area3_list_0" class="item" style="<%if(tempvodList.size()>0){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_0" class="txt">至第10集</div></div>
		</div>
		<div id="area3_list_1" class="item" style="left:155px;<%if(tempvodList.size()>1){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_1" class="txt">至第12集</div></div>
		</div>
		<div id="area3_list_2" class="item" style="left:310px;<%if(tempvodList.size()>2){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_2" class="txt">至第02集</div></div>
		</div>
		<div id="area3_list_3" class="item" style="top:203px;<%if(tempvodList.size()>3){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_3" class="txt">至第12集</div></div>
		</div>
		<div id="area3_list_4" class="item" style="left:155px;top:203px;<%if(tempvodList.size()>4){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_4" class="txt">至第03集</div></div>
		</div>
		<div id="area3_list_5" class="item" style="left:310px;top:203px;<%if(tempvodList.size()>5){%>visibility:visible;<%}else{%>visibility:hidden;<%}%>">
			...
			<div class="txt-mark"><div id="area3_episode_5" class="txt">至第12集</div></div>
		</div>
	</div>
<!-- list the end-->
