...
String areaid=request.getParameter("areaid")==null?"5":request.getParameter("areaid");
String indexid=request.getParameter("indexid")==null?"3":request.getParameter("indexid");
...
int area5SelectIndex = request.getParameter("area5SelectIndex")==null?3:Integer.parseInt(request.getParameter("area5SelectIndex"));
...
var area5={curindex:0,datanum:5,name:"area5"};


var curr_focus=<%=indexid%>;   
var curareaindex=<%=areaid%>;
var curindex=<%=indexid%>;
...
area5.ok = function(){
	...
	switch(area5.curindex){		
		...
		break;
		case 3:
			window.location.href="<%=tempProperBath%>tvLive.jsp?categoryCode="+"<%=categoryCode_yszb%>"+"&categoryName=经视直播&areaid=5&indexid=3&area5SelectIndex=3";
		break;
		case 4:
			window.location.href="<%=tempProperBath%>tvLive.jsp?categoryCode="+"<%=categoryCode_cjhxw%>"+"&categoryName=长江新闻号&areaid=5&indexid=4&area5SelectIndex=4";
		break;
		default:
		break;
	}
...
area5.changefocusEvent = function(stepvalue)
{

	 $("area5_list_"+area5.curindex).blur();
	 area5.curindex=stepvalue+area5.curindex;
	 if(area5.curindex<0)
	 {
		area5.curindex=area5.datanum-1;
	 }
	 if(area5.curindex>=area5.datanum)
	 {
	     area5.curindex=0;
	 }
	 $("area5_list_"+area5.curindex).focus();	 
...
pageobj.backurl="<%=tempProperBath%>newsIndex.jsp";
	...
	switch(direction){
		   ...
		   case 1:
		   {
				...
				else if(pageobj.curareaindex==3)
				{
					...
					$('area1_list_'+area1.curindex).focus();
					pageobj.curareaindex=1;
	            }else if(pageobj.curareaindex==5){
					pageobj.areas[5].changefocusEvent(-1);
				}
			    break; 
		   }
		   case 2:
...
<!--pagebg-->
<div class="pagebg">
	<div class="pic"><img src="../images/bg-news-live01.jpg" width="640" height="127" /></div>
...
<div class="wrapper">
	...
	<div class="menu-news">
		...
		<div class="item item01">
			<div class="link"><a id="area5_list_0" href="#"><img src="../images/t.gif" width="61" height="40" /></a></div>
			<div class="txt">首页</div>
        </div>
		<div class="item item04" style="left:128px;">
			<div class="link"><a id="area5_list_1" href="#"><img src="../images/t.gif" width="87" height="40" /></a></div>
			<div class="txt">湖北</div>
        </div>
		<div class="item item01" style="left:240px;">
			<div class="link"><a id="area5_list_2" href="#"><img src="../images/t.gif" width="61" height="40" /></a></div>
			<div class="txt">名栏</div>
        </div>
		<div class="<%if(area5SelectIndex==3){%>item item02 item02_select<%}else{%>item item02<%}%>" style="left:325px;">
			<div class="link"><a id="area5_list_3" href="#"><img src="../images/t.gif" width="112" height="40" /></a></div>
			<div class="txt">经视直播</div>
        </div>
		<div class="<%if(area5SelectIndex==4){%>item item03 item03_select<%}else{%>item item03<%}%>" style="left:460px;">
			<div class="link"><a id="area5_list_4" href="#"><img src="../images/t.gif" width="142" height="40" /></a></div>
