...
<%
	...
	String propeertiespathInfo = request.getRequestURI();
	String tempProperBath="";
	if(propeertiespathInfo.indexOf("epgPage/")!=-1){
			String[] tempFirstBathstrs = propeertiespathInfo.split("epgPage/");
	   		tempProperBath = tempFirstBathstrs[0]+"epgPage/page/";
	}
%>