...
vodInfoMap = metaData.getVodDetailInfo(1579865);
if(vodInfoMap!= null)
{	
...
{		
	...
	if(subVodList != null && subVodList.size() > 0)
	{
		...
		for(int i = 0; i < totalSitNum; i++)
		{
			...
			if(sitVodId.toString().equals("1579865"))
			{
				currIndex = i;				
			}
		}	
...
var nextProgName="<%=nextProgName%>";
 ...
 alert(preProgId+" "+preProgNum +"===preProgId==");
 
  alert(nextProgId+" "+nextProgNum +"===nextProgNum==");
 
 
   alert(vodName+" "+preProgName +" "+nextProgName+"===preProgName==");
