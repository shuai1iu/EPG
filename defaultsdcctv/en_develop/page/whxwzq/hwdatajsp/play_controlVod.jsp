...
function pressOk()
{
	...
	else if(minEPGIsShowFlag==true)
	{
		...
		{
			unload();
			window.location.href="play_controlVod.jsp?PROGID="+preProgId+"&PLAYTYPE=1"+"&TYPE_ID="+"<%=typeId%>";
		}
		else
		{
			unload();
			window.location.href="play_controlVod.jsp?PROGID="+nextProgId+"&PLAYTYPE=1"+"&TYPE_ID="+"<%=typeId%>";
		}
	}
	else if(seekDivIsShowFlag==true)
	{
