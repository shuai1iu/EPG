...
int contentTotal=0;
String typeID = "10000100000000090000000000032832";
...
if(vodlist!=null && vodlist.size() > 1 && ((ArrayList)vodlist.get(1)).size() > 0)
{
	...
	for(int i = 0;i<vod_list.size();i++)
    {
     ...
     /* mediadetailInfo = (HashMap)metadata.getVodDetailInfo(Integer.parseInt(tmpvodid));
...
ppvListData=<%=jsonvodlist%>;
contentTotal = <%=contentTotal%>;
if(isFirstFlag==1)
{
	window.parent.bindFilmsData(ppvListData);
}
</script>