...
<%@ include file="datajsp/playbackdataJP.jsp"%>
...
var AjaxReturn = -1;
        ...
        function initPage() {
			...
			area1 = AreaCreator(7, 1, new Array(-1, 2, -1, -1), new Array("date", "date_a"), new Array("className:item item_select", "className:link onboder"), new Array("className:item", "className:link offboder"));
            ...
            area2.asyngetdata = function(date) {
		        ...
		        AjaxReturn = -1;
		       if(pageobj.curareaid == 2)  area2.doms[area2.curindex].changefocus(true);
            }
	        area2.setcrossturnpage();
		        ...
		        if(requestChannelId != null && requestChannelId != undefined && requestChannelId != "" && requestChannelId != "null")
		         {
			      ...
			      if(currIndex != undefined && currIndex != "undefined") pageobj = new PageObj(0,parseInt(currIndex), new Array(area0, area1, area2));
		        }
		       else  pageobj = new PageObj(0,0, new Array(area0, area1, area2));
				
		  }
	       if(returnurl != null && returnurl != undefined && returnurl != "" && returnurl != "null")
			 pageobj.backurl = returnurl;
	        else  pageobj.backurl = "index.jsp?back=1";
			 setDarkFocus();
             pagerChannelList();
        }
				 ...
				 //$("currDate").innerHTML="210";
			       firstChannelId = data[0].channelId;
					...
					else
					{
			         ...
			         var url1 = "datajsp/playbackdateList.jsp?iflag=0&channelId=" + firstChannelId;
                  	getAJAXData(url1, getDateList);
					// $("currDate").innerHTML=url1;
