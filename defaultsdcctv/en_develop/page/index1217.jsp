...
String apppic="";
//tag 是开机广告的标识 1或null说明需要加载广告 3不需要加载广告
...
if(tag==null||tag==1)
{
	...
	try{
		tmpAdVas=(ArrayList)new MetaData(request).getVasListByTypeId("0000100000000090000000000038451",6,0);
	} catch(Exception e){
...
/*
    ...
    @date 2013-10-31
*/
        var changeRecommend =  window.setInterval("changeImage()",2000);
        var changeFlag = 1;
//标识位 是否进入广告
var tag=<%=tag%>;
var apppic ="<%=apppic%>";
...
function VASimg1(data,area)
{
	...
	if(2<area.datanum)
	{
		...
		area.doms[2].mylink = "../../../"+data[0].VASURL+"?returnurl="+returnurl;			
	/**
