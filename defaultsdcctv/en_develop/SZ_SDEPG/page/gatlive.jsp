...
.link { left: 0px; top: 0px; z-index:-2;}
.txt { left: 0px; z-index:-4;}
.txt-wrap { z-index:-5;}
.icon { z-index:-6;}
.pic-shade { z-index:-7;}
.pic { z-index:-8;}
...
function setMuteFlag()
{
	...
	if(muteFlag == 1)
	{
		...
		if (mp.getNativeUIFlag() == 0 || mp.getMuteUIFlag() == 0)
		{
			...
			document.getElementById("voice").src="../images/muteoff.png";
	...
	else
	{
		...
		if (mp.getNativeUIFlag() == 0 || mp.getMuteUIFlag() == 0)
		{
			...
			document.getElementById("voice").src="../images/muteon.png";
			voiceTimer = setTimeout("hideVoice();", 5000);
		}
	}      
}
...
<img id="voice" src="../images/dot.gif"/></div>
</body>
</html>
