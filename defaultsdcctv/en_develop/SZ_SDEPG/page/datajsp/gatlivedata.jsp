...
ArrayList result = metaData.getChanListByTypeId("10000100000000090000000000031288",7,0);
...
int vodpagecount=0;
int vodpagesize=4;
ArrayList list = metaData.getVodListByTypeId("00000100000000090000000000017158", 999, 0);
